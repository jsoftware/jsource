...
ifeq ($(TARGET_ARCH_ABI),arm64-v8a)
  LOCAL_CFLAGS := -DC_CRC32C=1 -DEMU_AVX=1 -DPYXES=1 -DSLEEF=1 -DENABLE_ADVSIMD -DHAVE_NEON64=1 -fPIC -Os -fvisibility=hidden -fwrapv -Werror -Wno-string-plus-int -Wno-empty-body -Wno-parentheses -Wno-pointer-sign -Wno-pointer-to-int-cast -Wno-logical-op-parentheses -Wno-unused-value -Wno-null-dereference -Wno-type-limits -Wno-pass-failed -D_FORTIFY_SOURCE=2 -Werror=fortify-source -fno-strict-aliasing -fwrapv -march=armv8-a+crc+crypto -Wno-sign-compare -mno-outline-atomics -DDORENAME -I../sleef/src/arch -I../sleef/src/common
  LOCAL_ARM_NEON := true
  LOCAL_CFLAGS += -fopenmp
  LOCAL_LDFLAGS += -fopenmp -static-openmp
endif
ifeq ($(TARGET_ARCH_ABI),armeabi-v7a)
  LOCAL_CFLAGS := -fPIC -Os -fvisibility=hidden -fwrapv -Werror -Wno-string-plus-int -Wno-empty-body -Wno-parentheses -Wno-pointer-sign -Wno-pointer-to-int-cast -Wno-logical-op-parentheses -Wno-unused-value -Wno-null-dereference -Wno-type-limits -Wno-pass-failed -D_FORTIFY_SOURCE=2 -Werror=fortify-source -fno-strict-aliasing -fwrapv -mfloat-abi=softfp -march=armv7-a -Wno-sign-compare
  LOCAL_ARM_MODE := arm
  LOCAL_ARM_NEON := true
  LOCAL_CFLAGS += -fopenmp
  LOCAL_LDFLAGS += -fopenmp -static-openmp
...
ifeq ($(TARGET_ARCH_ABI),armeabi)
  LOCAL_CFLAGS := -std=c99 -Wno-unknown-warning-option -fPIC -Os -fvisibility=hidden -fwrapv -Werror -Wno-overflow -Wno-string-plus-int -Wno-empty-body -Wno-int-to-pointer-cast -Wno-parentheses -Wno-pointer-sign -Wno-pointer-to-int-cast -Wno-logical-op-parentheses -Wno-unused-value -Wno-null-dereference -Wno-type-limits -fno-strict-aliasing -fwrapv -mfloat-abi=softfp -march=armv5te -Wno-sign-compare
  LOCAL_ARM_MODE := arm
  LOCAL_CFLAGS += -fopenmp
  LOCAL_LDFLAGS += -fopenmp
endif
ifeq ($(TARGET_ARCH),x86_64)
  LOCAL_CFLAGS := -DC_CRC32C=1 -DEMU_AVX=1 -DPYXES=1 -DSLEEF=1 -DENABLE_SSE2 -DHAVE_SSSE3=1 -DHAVE_SSE42=1 -fPIC -Os -fvisibility=hidden -fwrapv -Werror -Wno-string-plus-int -Wno-empty-body -Wno-parentheses -Wno-pointer-sign -Wno-pointer-to-int-cast -Wno-logical-op-parentheses -Wno-unused-value -Wno-null-dereference -Wno-type-limits -Wno-pass-failed -D_FORTIFY_SOURCE=2 -Werror=fortify-source -fno-strict-aliasing -fwrapv -march=x86-64 -msse4.2 -mpopcnt -fno-stack-protector -Wno-sign-compare -DDORENAME -I../sleef/src/arch -I../sleef/src/common
  LOCAL_CFLAGS += -fopenmp
  LOCAL_LDFLAGS += -fopenmp -static-openmp
endif
ifeq ($(TARGET_ARCH),x86)
  LOCAL_CFLAGS := -DSLEEF=1 -DENABLE_SSE2 -fPIC -Os -fvisibility=hidden -fwrapv -Werror -Wno-string-plus-int -Wno-empty-body -Wno-parentheses -Wno-pointer-sign -Wno-pointer-to-int-cast -Wno-logical-op-parentheses -Wno-unused-value -Wno-null-dereference -Wno-type-limits -Wno-pass-failed -D_FORTIFY_SOURCE=2 -Werror=fortify-source -fno-strict-aliasing -fwrapv -march=i686 -mssse3 -mfpmath=sse -fno-stack-protector -Wno-sign-compare -DDORENAME -I../sleef/src/arch -I../sleef/src/common
  LOCAL_CFLAGS += -fopenmp
  LOCAL_LDFLAGS += -fopenmp -static-openmp
endif
