...
ifeq ($(TARGET_ARCH_ABI),armeabi)
  LOCAL_CFLAGS := -std=gnu99 -Wno-unknown-warning-option -fPIC -Os -fvisibility=hidden -fwrapv -Werror -Wno-overflow -Wno-string-plus-int -Wno-empty-body -Wno-int-to-pointer-cast -Wno-parentheses -Wno-pointer-sign -Wno-pointer-to-int-cast -Wno-incompatible-function-pointer-types -Wno-logical-op-parentheses -Wno-unused-value -Wno-null-dereference -Wno-type-limits -Wno-return-local-addr -fno-strict-aliasing -mfloat-abi=softfp -march=armv5te -Wno-sign-compare -I../mpir/include
  LOCAL_ARM_MODE := arm
  LOCAL_CFLAGS += -fopenmp
