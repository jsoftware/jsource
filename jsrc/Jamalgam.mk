...
ifeq ($(TARGET_ARCH_ABI),arm64-v8a)
  LOCAL_CFLAGS := -DC_CRC32C=1 -DEMU_AVX2=1 -DPYXES=1 -DSLEEF=1 -DENABLE_ADVSIMD -DHAVE_NEON64=1 -fPIC -Os -fvisibility=hidden -fwrapv -Werror -Wno-string-plus-int -Wno-empty-body -Wno-parentheses -Wno-pointer-sign -Wno-pointer-to-int-cast -Wno-incompatible-function-pointer-types -Wno-logical-op-parentheses -Wno-unused-value -Wno-null-dereference -Wno-type-limits -Wno-pass-failed -D_FORTIFY_SOURCE=2 -Werror=fortify-source -fno-strict-aliasing -march=armv8-a+crc+crypto -Wno-sign-compare -Wno-deprecated-non-prototype -mno-outline-atomics -DDORENAME -I../sleef/src/arch -I../sleef/src/common -I../mpir/include
  LOCAL_ARM_NEON := true
  LOCAL_CFLAGS += -fopenmp
  LOCAL_LDFLAGS += -fopenmp -static-openmp
endif
ifeq ($(TARGET_ARCH_ABI),armeabi-v7a)
  LOCAL_CFLAGS := -DARMEABI_V7A -fPIC -Os -fvisibility=hidden -fwrapv -Werror -Wno-string-plus-int -Wno-empty-body -Wno-parentheses -Wno-pointer-sign -Wno-pointer-to-int-cast -Wno-incompatible-function-pointer-types -Wno-logical-op-parentheses -Wno-unused-value -Wno-null-dereference -Wno-type-limits -Wno-pass-failed -Wno-shift-count-overflow -D_FORTIFY_SOURCE=2 -Werror=fortify-source -fno-strict-aliasing -mfloat-abi=softfp -march=armv7-a -Wno-sign-compare -I../mpir/include
  LOCAL_ARM_MODE := arm
  LOCAL_ARM_NEON := true
  LOCAL_CFLAGS += -fopenmp
  LOCAL_LDFLAGS += -fopenmp -static-openmp
...
ifeq ($(TARGET_ARCH_ABI),armeabi)
  LOCAL_CFLAGS := -std=gnu99 -Wno-unknown-warning-option -fPIC -Os -fvisibility=hidden -fwrapv -Werror -Wno-overflow -Wno-string-plus-int -Wno-empty-body -Wno-int-to-pointer-cast -Wno-parentheses -Wno-pointer-sign -Wno-pointer-to-int-cast -Wno-incompatible-function-pointer-types -Wno-logical-op-parentheses -Wno-unused-value -Wno-null-dereference -Wno-type-limits -Wno-return-local-addr -Wno-shift-count-overflow -fno-strict-aliasing -mfloat-abi=softfp -march=armv5te -Wno-sign-compare -I../mpir/include
  LOCAL_ARM_MODE := arm
  LOCAL_CFLAGS += -fopenmp
  LOCAL_LDFLAGS += -fopenmp
endif
ifeq ($(TARGET_ARCH),x86_64)
  LOCAL_CFLAGS := -DC_CRC32C=1 -DEMU_AVX2=1 -DPYXES=1 -DSLEEF=1 -DENABLE_SSE2 -DHAVE_SSSE3=1 -DHAVE_SSE42=1 -fPIC -Os -fvisibility=hidden -fwrapv -Werror -Wno-string-plus-int -Wno-empty-body -Wno-parentheses -Wno-pointer-sign -Wno-pointer-to-int-cast -Wno-incompatible-function-pointer-types -Wno-logical-op-parentheses -Wno-unused-value -Wno-null-dereference -Wno-type-limits -Wno-pass-failed -D_FORTIFY_SOURCE=2 -Werror=fortify-source -fno-strict-aliasing -march=x86-64 -msse4.2 -mpopcnt -fno-stack-protector -Wno-sign-compare -Wno-deprecated-non-prototype -DDORENAME -I../sleef/src/arch -I../sleef/src/common -I../mpir/include
  LOCAL_CFLAGS += -fopenmp
  LOCAL_LDFLAGS += -fopenmp -static-openmp
endif
...
../libbacktrace/elf.c \
 a.c ab.c aes-c.c aes-arm.c aes-sse2.c af.c ai.c am.c am1.c amn.c ao.c ap.c ar.c as.c au.c c.c ca.c cc.c cd.c cf.c cg.c ch.c cip.c cl.c cp.c cpdtsp.c cpuinfo.c cr.c crs.c \
	...
	vf.c vfft.c vfrom.c  vfromsp.c vg.c vgauss.c vgcomp.c vgranking.c vgsortiqavx512.c vgsort.c vgsp.c vi.c viavx.c viavx1-2.c viavx1-4.c viavx2.c viavx3.c viavx4.c viavx5.c viavx6.c viix.c visp.c vm.c vo.c vp.c vq.c vrand.c vrep.c vs.c vsb.c \
