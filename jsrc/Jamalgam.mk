...
../libbacktrace/elf.c \
 a.c ab.c aes-arm.c aes-c.c aes-sse2.c af.c ai.c am.c am1.c amn.c ao.c ap.c ar.c as.c au.c c.c ca.c cblas.c cc.c cd.c cf.c cg.c ch.c cip.c cl.c cp.c cpdtsp.c cpuinfo.c cr.c crs.c \
	...
	vf.c vfft.c vfrom.c vfromlp.c vfromsp.c vg.c vgauss.c vgcomp.c vgranking.c vgsortiqavx512.c vgsort.c vgsp.c vi.c viavx.c viavx1-2.c viavx1-4.c viavx2.c viavx3.c viavx4.c viavx5.c viavx6.c viix.c visp.c vm.c vo.c vp.c vq.c vrand.c vrep.c vs.c vsb.c \
