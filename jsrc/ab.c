...
#else
APFX(bw0000II, I,UI,UI, BW0000,, R EVOK;)
APFX(bw0001II, I,UI,UI, BW0001,, R EVOK;) 
APFX(bw0010II, I,UI,UI, BW0010,, R EVOK;)
APFX(bw0011II, I,UI,UI, BW0011,, R EVOK;)
// commutative APFX(bw0100II, UI,UI,UI, BW0100,, R EVOK;)
// commutative APFX(bw0101II, UI,UI,UI, BW0101,, R EVOK;)
APFX(bw0110II, I,UI,UI, BW0110,, R EVOK;)
APFX(bw0111II, I,UI,UI, BW0111,, R EVOK;)
APFX(bw1000II, I,UI,UI, BW1000,, R EVOK;)
APFX(bw1001II, I,UI,UI, BW1001,, R EVOK;)
APFX(bw1010II, I,UI,UI, BW1010,, R EVOK;)
APFX(bw1011II, I,UI,UI, BW1011,, R EVOK;)
// commutative APFX(bw1100II, UI,UI,UI, BW1100,, R EVOK;)
// commutative APFX(bw1101II, UI,UI,UI, BW1101,, R EVOK;)
APFX(bw1110II, I,UI,UI, BW1110,, R EVOK;)
APFX(bw1111II, I,UI,UI, BW1111,, R EVOK;)
#endif
APFX(bw10000II, I,I,UI, BW10000,, R EVOK;)
APFX(bw10001II, I,I,UI, BW10001,, R EVOK;)
APFX(bw10010II, I,I,I, BW10010,, R EVOK;)
APFX(bw10000I2I2, UI2,I2,UI2, BW10000,, R EVOK;)   // scaf this doesn't sign-extend correctly, or handle 16<shiftct<64 
