...
primop256(bw1000II,1,__m256d ones=_mm256_setzero_pd(); ones=_mm256_castsi256_pd(_mm256_cmpeq_epi32(ones,ones));,zz=_mm256_xor_pd(ones,_mm256_or_pd(xx,yy)),R EVOK;)
primop256(bw1001II,1,__m256d ones=_mm256_setzero_pd(); ones=_mm256_castsi256_pd(_mm256_cmpeq_epi32(ones,ones));,zz=_mm256_xor_pd(ones,_mm256_xor_pd(xx,yy)),R EVOK;)
primop256(bw1010II,0,__m256d ones=_mm256_setzero_pd(); ones=_mm256_castsi256_pd(_mm256_cmpeq_epi32(ones,ones));,zz=_mm256_xor_pd(ones,yy),R EVOK;)
primop256(bw1011II,0,__m256d ones=_mm256_setzero_pd(); ones=_mm256_castsi256_pd(_mm256_cmpeq_epi32(ones,ones));,zz=_mm256_xor_pd(ones,_mm256_andnot_pd(xx,yy)),R EVOK;)
primop256(bw1100II,0,__m256d ones=_mm256_setzero_pd(); ones=_mm256_castsi256_pd(_mm256_cmpeq_epi32(ones,ones));,zz=_mm256_xor_pd(ones,xx),R EVOK;)
primop256(bw1101II,0,__m256d ones=_mm256_setzero_pd(); ones=_mm256_castsi256_pd(_mm256_cmpeq_epi32(ones,ones));,zz=_mm256_xor_pd(ones,_mm256_andnot_pd(yy,xx)),R EVOK;)
primop256(bw1110II,1,__m256d ones=_mm256_setzero_pd(); ones=_mm256_castsi256_pd(_mm256_cmpeq_epi32(ones,ones));,zz=_mm256_xor_pd(ones,_mm256_and_pd(xx,yy)),R EVOK;)
primop256(bw1111II,1,__m256d ones=_mm256_setzero_pd(); ones=_mm256_castsi256_pd(_mm256_cmpeq_epi32(ones,ones));,zz=ones,R EVOK;)
#else
...
/* see below */                        /* see below */
       ...
       AHDRR(bw0000insI,UI,UI){I k=SZI*m*d; mvc(k,z,1,MEMSET00); R EVOK;}
static AHDRR(bw0000insC,UC,UC){I k=    m*d; mvc(k,z,1,MEMSET00); R EVOK;}
