...
*/
  ...
  {A a1,y;I*aa,i,*u,*ww=(I*)wv,*v,*yv,*zv;VA2 adocv; VARPS adocvsum;
   ...
   for(i=0;i<zn;++i){
    ...
    p=MIN(1+i,zn-i); p=MIN(p,k);
    I rc=((AHDR2FN*)adocv.f)AH2A_x1(p,u,v,yv,jt); rc=rc<0?EWOVIP+EWOVIPMULII:rc; if(rc&255)jsignal(rc); if(255&(rc=((AHDRRFN*)adocvsum.f)((I)1,p,(I)1,yv,zv,jt)))jsignal(rc);
    ++zv;
   }
...
#define KSLGLPMEAN(wincr,zincr,pwvinit,pwvupd,freqt) \
 ...
 for(indexx=0, indexn=AN(ai), wv=voidAV(w); indexx!=indexn;++indexx, wv=(C*)wv+(wincr)){ \
    ...
    switch(routineid){
    case 3: {I rc; KSLGLP(celllen,celllen,MC(partition,wv,celllen);,ASSERT(EVOK==(rc=((AHDR2FN*)adocv.f)AH2A_x1(cellatoms,wv,partition,partition,jt), rc=rc<0?EWOVIP+EWOVIPMULII:rc),rc)) break;}  // <. >.
    case 7: {I rc; KSLGLP(cellatoms,celllen,DO(cellatoms, ((I*)partition)[i]=((C*)wv)[i];),ASSERT(EVOK==(rc=((AHDR2FN*)adocv.f)AH2A_x1(cellatoms,wv,partition,partition,jt), rc=rc<0?EWOVIP+EWOVIPMULII:rc),rc)) break;}  // + B01
    case 11: {I rc; KSLGLPMEAN(cellatoms,celllen,DO(cellatoms, ((D*)partition)[i]=((B*)wv)[i];),ASSERT(EVOK==(rc=((AHDR2FN*)adocv.f)AH2A_x1(cellatoms,wv,partition,partition,jt), rc=rc<0?EWOVIP+EWOVIPMULII:rc),rc),D) break;}  // mean B01
    case 15: {I rc; KSLGLPMEAN(celllen,celllen,DO(cellatoms, ((D*)partition)[i]=((I*)wv)[i];),ASSERT(EVOK==(rc=((AHDR2FN*)adocv.f)AH2A_x1(cellatoms,wv,partition,partition,jt), rc=rc<0?EWOVIP+EWOVIPMULII:rc),rc),D) break;}  // mean INT
    case 16: {I rc; KSLGLPMEAN(celllen,celllen,MC(partition,wv,celllen);,ASSERT(EVOK==(rc=((AHDR2FN*)adocv.f)AH2A_x1(cellatoms,wv,partition,partition,jt), rc=rc<0?EWOVIP+EWOVIPMULII:rc),rc),I) break;}  // mean for XNUM/RAT
    case 17: {I rc; KSLGLPMEAN(celllen,celllen,MC(partition,wv,celllen);,ASSERT(EVOK==(rc=((AHDR2FN*)adocv.f)AH2A_x1(cellatoms,wv,partition,partition,jt), rc=rc<0?EWOVIP+EWOVIPMULII:rc),rc),D) break;}  // mean for FL
...
#define KSLSRLPMEAN(wincr,zincr,pwvinit,pwvupd,freqt) \
 ...
 for(av=IAV(a), wv=voidAV(w); nitems; av=(I*)((I)av+k), wv=(C*)wv+(wincr),--nitems){ \
    ...
    switch(routineid){
    case 3: {I rc; KSLSRLP(celllen,celllen,MC(partition,wv,celllen);,ASSERT(EVOK==(rc=((AHDR2FN*)adocv.f)AH2A_x1(cellatoms,wv,partition,partition,jt), rc=rc<0?EWOVIP+EWOVIPMULII:rc),rc)) break;}  // <. >.
    case 7: {I rc; KSLSRLP(cellatoms,celllen,DO(cellatoms, ((I*)partition)[i]=((C*)wv)[i];),ASSERT(EVOK==(rc=((AHDR2FN*)adocv.f)AH2A_x1(cellatoms,wv,partition,partition,jt), rc=rc<0?EWOVIP+EWOVIPMULII:rc),rc)) break;}  // + B01
    case 11: {I rc; KSLSRLPMEAN(cellatoms,celllen,DO(cellatoms, ((D*)partition)[i]=((B*)wv)[i];),ASSERT(EVOK==(rc=((AHDR2FN*)adocv.f)AH2A_x1(cellatoms,wv,partition,partition,jt), rc=rc<0?EWOVIP+EWOVIPMULII:rc),rc),D) break;}  // mean B01
    case 15: {I rc; KSLSRLPMEAN(celllen,celllen,DO(cellatoms, ((D*)partition)[i]=((I*)wv)[i];),ASSERT(EVOK==(rc=((AHDR2FN*)adocv.f)AH2A_x1(cellatoms,wv,partition,partition,jt), rc=rc<0?EWOVIP+EWOVIPMULII:rc),rc),D) break;}  // mean INT
    case 16: {I rc; KSLSRLPMEAN(celllen,celllen,MC(partition,wv,celllen);,ASSERT(EVOK==(rc=((AHDR2FN*)adocv.f)AH2A_x1(cellatoms,wv,partition,partition,jt), rc=rc<0?EWOVIP+EWOVIPMULII:rc),rc),I) break;}  // mean for XNUM/RAT
    case 17: {I rc; KSLSRLPMEAN(celllen,celllen,MC(partition,wv,celllen);,ASSERT(EVOK==(rc=((AHDR2FN*)adocv.f)AH2A_x1(cellatoms,wv,partition,partition,jt), rc=rc<0?EWOVIP+EWOVIPMULII:rc),rc),D) break;}  // mean for FL
