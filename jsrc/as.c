...
static DF1(jtsuffix){F1PREF;DECLF;I r;
 RZ(w);
...
static DF1(jtgsuffix){F1PREF;A h,*hv,z,*zv;I m,n,r;
 RZ(w);
...
static DF1(jtssgu){F1PREF;A fs,q,x,y,z;AF f2;C*zv;I i,k,m,n1,old,r,t;V*sv=VAV(self);
...
static DF1(jtssg){F1PREF;A fs,q,y,z,*zv;AF f2;B p;C*u,*v;I i,k,n,yn,yr,*ys,yt;V*sv=VAV(self);
...
static DF1(jtsscan){F1PREF;A y,z;C id;I c,cv,f,m,n,r,rr[2],t,wn,wr,*ws,wt,zt;VF ado;
 RZ(w);
 wt=AT(w);
...
static F2(jtomask){F2PREF;A c,r,x,y;I m,n,p;
 RZ(a&&w);
...
static DF2(jtgoutfix){F2PREF;A h,*hv,x,z,*zv;I m,n;
 RZ(x=omask(a,w));
 n=IC(x);
 h=VAV(self)->h; hv=AAV(h); m=AN(h);
 GA(z,BOX,n,1,0); zv=AAV(z);
...
static DF2(jtofxinv){F2PREF;A f,fs,z;C c;I t;V*v;
...
static DF2(jtofxassoc){F2PREF;A f,i,j,p,s,x,z;C id,*zv;I c,cv,d,k,kc,m,r,t;V*v;VF ado;
...
static DF1(jtiota1rev){F1PREF;R apv(IC(w),IC(w),-1L);}

F1(jtbsdot){F1PREF;A f;AF f1=jtsuffix,f2=jtoutfix;C id;V*v;
 RZ(w);
