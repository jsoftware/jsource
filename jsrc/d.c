...
A jteformat(J jtfg,A self,A a,A w,A m){F12IP;
  ...
  // obsolete        A rnk; if((rnk=v2((I)(B)jt->ranks,(I)(B)(jt->ranks>>RANKTX)))==0)goto noeformat; // cell ranks
       A rnk; if((rnk=v2(~(I)w&0x3f,~(I)a&0x3f))==0)goto noeformat; a=(A)((I)a&~0x3f); w=(A)((I)w&~0x3f); // cell ranks, and clear them from a/w
