...
F1(jtdbcutback  ){F12IP;R ssdo(0L,w,SSCUTBACK);}  /* 13!:19 */
// should allow w to have the value to return to the function

F1(jtdbstepover1){F12IP;R ssdo(0L,w,SSSTEPOVER);}  /* 13!:20 */
F2(jtdbstepover2){F12IP;R ssdo(a, w,SSSTEPOVER);}

F1(jtdbstepinto1){F12IP;R ssdo(0L,w,SSSTEPINTO);}  /* 13!:21 */
F2(jtdbstepinto2){F12IP;R ssdo(a, w,SSSTEPINTO);}

F1(jtdbstepout1 ){F12IP;R ssdo(0L,w,SSSTEPOUT );}  /* 13!:22 */
F2(jtdbstepout2 ){F12IP;R ssdo(a, w,SSSTEPOUT );}
