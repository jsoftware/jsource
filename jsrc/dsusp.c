...
DC jtdeba(J jt,I t,void *x,void *y,A fs){DC d;
 ...
 case DCPM:
  ...
  d->dcdyad=PEXT0(t,7,1);  // remember if dyadic verb execution
...
A jtpee(J jt,A *queue,UI8 tcesx2,I err,I lk){A z=0;
 ...
 PFRAME oframe=jt->parserstackframe; PSTK newparseinfo[1]={{.a=(A)(&queue[SHMSK(tcesx2,32,TCESXSXMSK)]),.t=(tcesx2-(tcesx2>>32))&TCESXSXMSK}};
