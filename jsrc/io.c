...
int _stdcall JDo(JS jt, C* lp){int r; UI savcstackmin, savcstackinit, savqtstackinit;JJ jm=MTHREAD(jt);  // get address of thread struct we are using (the master thread)
