...
#define CNULLNOERR(x) ({A res=(x); if(res&&(AT(res)&BOX+PYX)==BOX+PYX)res=jtpyxvalid(jt,res); res; })   // if x is 0, keep it 0; ignore error, don't resolve pyx but use it if resolved
