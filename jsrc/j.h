...
#define SYMVALFA2(faname) if(faname!=0){AFLAGCLRKNOWN(faname); faaction(jt,faname)}   // must clear known before free, since once we reduce usect we cannot touch the block
