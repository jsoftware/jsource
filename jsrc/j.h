...
#ifndef MEMAUDIT
#define MEMAUDIT 0x7f   // scaf     // Bitmask for memory audits: 
...
#define GAT0(name,type,atoms,rank)  GATS(name,type,atoms,rank,0,type##SIZE,GACOPYSHAPE0,R 0)  // shape is 0, or empty if rank is 1
