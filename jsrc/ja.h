...
// obsolete #define dfs1(x,y)                   jtdfs1(jt,(x),(y)) 
// obsolete #define dfs2(x,y,z)                 jtdfs2(jt,(x),(y),(z)) 
// obsolete #define dfs1ip(x,y)                 jtdfs1(jtinplace,(x),(y)) 
// obsolete #define dfs2ip(x,y,z)               jtdfs2(jtinplace,(x),(y),(z)) 
