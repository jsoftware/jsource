...
#define rei0(x)            ({I r; A xa=(x); if(unlikely((xa)==0))R0; if(likely(ISDENSETYPE(AT(xa),INT+B01))){ASSERT(!AR(xa),EVRANK); r=BIV0(xa);}else{RE(r=jti0(jt,xa))} r;})  // INT/B01 quickly  scaf use more
