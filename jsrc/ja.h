...
#define tpush1(x)                   {I pushx=jt->tnextpushx; *(I*)((I)jt->tstack+(pushx&(NTSTACK-1)))=(I)(x); pushx+=SZI; if(!(pushx&(NTSTACK-1))){RZ(tg()); pushx+=SZI;} jt->tnextpushx=pushx; if(MEMAUDIT>=1)audittstack(jt,(x),ACUC(x));}
