...
// obsolete extern F1(jtdotnamesq);
// obsolete extern F1(jtdotnamess);
extern F1(jtdrep);
extern F1(jtdrx);
extern F1(jtduble);
extern F1(jtdx_test);
...
extern A        jtparsex(J,A*,I,B,CW*,DC,DC);
extern A        jtpaxis(J,I,A);
extern A        jtpcvt(J,I,A);
extern A        jtpee(J,A*,I,I,B,CW*,DC,DC);
