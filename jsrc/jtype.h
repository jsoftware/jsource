...
typedef struct {AF valencefns[2];A fgh[3];union { D lD; void *lvp; I lI; I4 lI4[4]; I lclr[2];} localuse;I4 flag;/* obsolete UI4 fdep;*/ UI4 flag2; RANK2T lrr; RANKT mr; C id; C lc;} V;  // two cachelines exactly
