...
#if BW==64
#define bplg(i) (CTTZ(i)<19&&(1LL<<((0x008bb6db408dc6c0>>3*CTTZ(i))&7))==bp(i)?(0x008bb6db408dc6c0>>3*CTTZ(i))&7 : *(I*)0 ) // scaf  // 010 001 011   101 101 101 101 101 101 000 000   100 011 011 100 011 011 000 000 = 0 1000 1011 1011 0110 1101 1011   0100 0000 1000 1101 1100 0110 1100 0000
