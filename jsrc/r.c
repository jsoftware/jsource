...
F1(jtarx){F1RANK(0,  jtarx,DUMMYSELF); R arep(  symbrdlocknovalerr(nfb(w)));}
F1(jtdrx){F1RANK(0,  jtdrx,DUMMYSELF); R drep(  symbrdlocknovalerr(nfb(w)));}
F1(jttrx){F1RANK(0,  jttrx,DUMMYSELF); R trep(  symbrdlocknovalerr(nfb(w)));}
