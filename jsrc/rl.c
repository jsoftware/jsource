...
// obsolete  if(1<m)RZ(tv[1]=incorp(fl&VGERR?tiefn(jtinplace,fxeach(BETWEENC(id,CFDOT,CFCODOT)?hs:gs,(A)&jtfxself[!!self]),ltext):lrr(BETWEENC(id,CFDOT,CFCODOT)?hs:gs)));  // fill in g if present
