...
/* Based on Aaron Gifford's Implementations */
...
#define sigma0_256(x) (S32(7,  (x)) ^ S32(18, (x)) ^ SHA2R(3 ,   (x)))
#define sigma1_256(x) (S32(17, (x)) ^ S32(19, (x)) ^ SHA2R(10,   (x)))

/* Four of six logical functions used in SHA-384 and SHA-512: */
#define Sigma0_512(x) (S64(28, (x)) ^ S64(34, (x)) ^ S64(39, (x)))
#define Sigma1_512(x) (S64(14, (x)) ^ S64(18, (x)) ^ S64(41, (x)))
#define sigma0_512(x) (S64( 1, (x)) ^ S64( 8, (x)) ^ SHA2R( 7,   (x)))
#define sigma1_512(x) (S64(19, (x)) ^ S64(61, (x)) ^ SHA2R( 6,   (x)))
...
/*** SHA-224: *********************************************************/
static void SHA224_Init(SHA256_CTX* context)
{
