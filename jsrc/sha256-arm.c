...
#ifdef _MSC_VER
static const __declspec(align(16)) uint32_t K[] =
#else
static const uint32_t __attribute__ ((aligned (16))) K[] =
#endif
{
...
void sha256_process_arm(uint32_t state[8], const uint8_t data[], uintptr_t length)
{
#ifdef _MSC_VER
  __declspec(align(16)) uint32x4_t STATE0, STATE1, ABEF_SAVE, CDGH_SAVE;
  __declspec(align(16)) uint32x4_t MSG0, MSG1, MSG2, MSG3;
  __declspec(align(16)) uint32x4_t TMP0, TMP1, TMP2;
#else
  uint32x4_t __attribute__ ((aligned (16))) STATE0, STATE1, ABEF_SAVE, CDGH_SAVE;
  uint32x4_t __attribute__ ((aligned (16))) MSG0, MSG1, MSG2, MSG3;
  uint32x4_t __attribute__ ((aligned (16))) TMP0, TMP1, TMP2;
#endif
