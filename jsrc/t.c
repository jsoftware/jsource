...
// unsupported /* }:: */  PRIMACV(CEMEND,  ADV,  jtemend,   jtvalenceerr,  0,   0,   0   ,VFLAGNONE,VF2NONE|VF2PRIM|VF2NAMELESS),
 ...
 /*  i. */  PRIMACV(CIOTA,   VERB, jtiota,    jtindexof,1,   RMAX,RMAX,VASGSAFE|VIRS2|VJTFLGOK2,VF2WILLOPEN2A|VF2WILLOPEN2W|VF2PRIM),
 /*  i: */  PRIMACV(CICO,    VERB, jtjico1,   jtjico2,  0,   RMAX,RMAX,VASGSAFE|VIRS2|VJTFLGOK2,VF2WILLOPEN2A|VF2WILLOPEN2W|VF2PRIM),
