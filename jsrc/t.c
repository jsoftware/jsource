...
PRIM primtab[256] = {
 ...
 /*  ^: */  PRIMACV(CPOWOP,  CONJ, jtvalenceerr1, jtpowop,  0,   0,   0   ,VFLAGNONE,VF2NONE),
 ...
 /*  ~  */  PRIMACV(CTILDE,  ADV,  jtswap,    jtvalenceerr2,  0,   0,   0   ,VFLAGNONE,VF2NONE),
 /*  ~. */  PRIMACV(CNUB,    VERB, jtnub,     jtvalenceerr2,  RMAX,RMAX,RMAX,VASGSAFE|VJTFLGOK1,VF2NONE),
 ...
 /*  .  */  PRIMACV(CDOT,    CONJ, jtvalenceerr1, jtdot,    0,   0,   0   ,VFLAGNONE,VF2NONE),
 /*  :  */  PRIMACV(CCOLON,  CONJ, jtvalenceerr1, jtcolon,  0,   0,   0   ,VFLAGNONE,VF2NONE),
 /*  :. */  PRIMACV(COBVERSE,CONJ, jtvalenceerr1, jtobverse,0,   0,   0   ,VFLAGNONE,VF2NONE),
 /*  :: */  PRIMACV(CADVERSE,CONJ, jtvalenceerr1, jtadverse,0,   0,   0   ,VFLAGNONE,VF2NONE),
 ...
 /*  ;. */  PRIMACV(CCUT,    CONJ, jtvalenceerr1,        jtcut,    0,   0,   0   ,VFLAGNONE,VF2NONE),
 ...
 /*  !. */  PRIMACV(CFIT,    CONJ, jtvalenceerr1, jtfit,    0,   0,   0   ,VASGSAFE,VF2NONE),
 /*  !: */  PRIMACV(CIBEAM,  CONJ, jtvalenceerr1, jtforeign,0,   0,   0   ,VFLAGNONE,VF2NONE),
 /*  /  */  PRIMACV(CSLASH,  ADV,  jtslash,   jtvalenceerr2, 0,   0,   0   ,VIRS1,VF2NONE),
 /*  /. */  PRIMACV(CSLDOT,  ADV,  jtsldot,   jtvalenceerr2, 0,   0,   0   ,VFLAGNONE,VF2NONE),
 /*  /: */  PRIMACV(CGRADE,  VERB, jtgrade1,  jtgrade2, RMAX,RMAX,RMAX,VASGSAFE|VIRS1|VIRS2|VJTFLGOK2,VF2NONE),
 /*  /.. */  PRIMACV(CSLDOTDOT,  ADV,  jtsldotdot,   jtvalenceerr2, 0,   0,   0   ,VFLAGNONE,VF2NONE),
 /*  \  */  PRIMACV(CBSLASH, ADV,  jtbslash,  jtvalenceerr2, 0,   0,   0   ,VIRS1,VF2NONE),
 /*  \. */  PRIMACV(CBSDOT,  ADV,  jtbsdot,   jtvalenceerr2, 0,   0,   0   ,VIRS1,VF2NONE),
 ...
 /*  [: */  PRIMACV(CCAP,    VERB, jtvalenceerr1,jtvalenceerr2, RMAX,RMAX,RMAX,VFLAGNONE,VF2NONE),   // not ASGSAFE since used for not-yet-defined names
 ...
 /*  {: */  PRIMACV(CTAIL,   VERB, jttail,    jtvalenceerr2,  RMAX,RMAX,RMAX,VASGSAFE|VIRS1|VJTFLGOK1,VF2NONE),
 /*  }  */  PRIMACV(CRBRACE, ADV,  jtamend,   jtvalenceerr2, 0,   0,   0   ,VASGSAFE|VJTFLGOK2,VF2NONE),
 /*  }* */  PRIMACV(CCASEV,  VERB, jtcasev,   jtvalenceerr2, RMAX,RMAX,RMAX,VFLAGNONE,VF2NONE),   // f2 gets filled in with pointer to a name when this is used
 /*  }. */  PRIMACV(CBEHEAD, VERB, jtbehead,  jtdrop,   RMAX,1,   RMAX,VASGSAFE|VIRS1|VIRS2|VJTFLGOK1|VJTFLGOK2,VF2NONE),  // alias CDROP
 /*  }: */  PRIMACV(CCTAIL,  VERB, jtcurtail, jtvalenceerr2, RMAX,RMAX,RMAX,VASGSAFE|VIRS1|VJTFLGOK1,VF2NONE),
 /*  "  */  PRIMACV(CQQ,     CONJ, jtvalenceerr1, jtqq,     0,   0,   0   ,VFLAGNONE,VF2NONE),
 ...
 /*  `  */  PRIMACV(CGRAVE,  CONJ, jtvalenceerr1, jttie,    0,   0,   0   ,VFLAGNONE,VF2NONE),
 /*  `. */       /* undefined */
 /*  `: */  PRIMACV(CGRCO,   CONJ, jtvalenceerr1, jtevger,  0,   0,   0   ,VFLAGNONE,VF2NONE),
 /*  @  */  PRIMACV(CAT,     CONJ, jtvalenceerr1, jtatop,   0,   0,   0   ,VFLAGNONE,VF2NONE),
 /*  @. */  PRIMACV(CATDOT,  CONJ, jtvalenceerr1, jtagendai, 0,   0,   0   ,VFLAGNONE,VF2NONE),
 /*  @: */  PRIMACV(CATCO,   CONJ, jtvalenceerr1, jtatco,   0,   0,   0   ,VFLAGNONE,VF2NONE),
 /*  &  */  PRIMACV(CAMP,    CONJ, jtvalenceerr1, jtamp,    0,   0,   0   ,VFLAGNONE,VF2NONE),
 /*  &. */  PRIMACV(CUNDER,  CONJ, jtvalenceerr1, jtunder,  0,   0,   0   ,VFLAGNONE,VF2NONE),
 /*  &: */  PRIMACV(CAMPCO,  CONJ, jtvalenceerr1,  jtampco,  0,   0,   0   ,VFLAGNONE,VF2NONE),
 ...
 /* }:: */  PRIMACV(CEMEND,  ADV,  jtemend,   jtvalenceerr2,  0,   0,   0   ,VFLAGNONE,VF2NONE),
 /* &.: */  PRIMACV(CUNDCO,  CONJ, jtvalenceerr1, jtundco,  0,   0,   0   ,VFLAGNONE,VF2NONE),
 /*  a. */       /* see above */
 /*  a: */       /* see above */
 /*  A. */  PRIMACV(CATOMIC, VERB, jtadot1,   jtadot2,  1,   0,   RMAX,VASGSAFE,VF2NONE),
 /*  b. */  PRIMACV(CBDOT,   ADV,  jtbdot,    jtvalenceerr2, 0,   0,   0   ,VASGSAFE,VF2NONE),
 ...
 /*  E. */  PRIMACV(CEBAR,   VERB, jtvalenceerr1, jtebar,   0,   RMAX,RMAX,VASGSAFE,VF2WILLOPEN2A|VF2WILLOPEN2W),
 /*  f. */  PRIMACV(CFIX,    ADV,  jtfix,     jtvalenceerr2, 0,   0,   0   ,VFLAGNONE,VF2NONE),
 /*  H. */  PRIMACV(CHGEOM,  CONJ, jtvalenceerr1, jthgeom,  0,   0,   0   ,VISATOMIC1|VASGSAFE,VF2NONE),
 ...
 /*  L. */  PRIMACV(CLDOT,   VERB, jtlevel1,  jtvalenceerr2, RMAX,RMAX,RMAX,VASGSAFE,VF2WILLOPEN1),
 /*  L: */  PRIMACV(CLCAPCO, CONJ, jtvalenceerr1, jtlcapco, 0,   0,   0   ,VFLAGNONE,VF2NONE),
 /*  M. */  PRIMACV(CMCAP,   ADV,  jtmemo,    jtvalenceerr2, 0,   0,   0   ,VFLAGNONE,VF2NONE),
 ...
 /*  S: */  PRIMACV(CSCAPCO, CONJ, jtvalenceerr1, jtscapco, 0,   0,   0   ,VFLAGNONE,VF2NONE),
 /*  t. */  PRIMACV(CTDOT,   CONJ, jtvalenceerr1, jttdot, 0,   0,   0   ,VFLAGNONE,VF2NONE),
 ...
 /*  F.  */  PRIMACV(CFDOT,  CONJ, jtvalenceerr1, jtfold,  0,   0,   0   ,VFLAGNONE,VF2NONE),
 /*  F.. */  PRIMACV(CFDOTDOT,  CONJ, jtvalenceerr1, jtfold,  0,   0,   0   ,VFLAGNONE,VF2NONE),
 /*  F.: */  PRIMACV(CFDOTCO,  CONJ, jtvalenceerr1, jtfold,  0,   0,   0   ,VFLAGNONE,VF2NONE),
 /*  F:  */  PRIMACV(CFCO,  CONJ, jtvalenceerr1, jtfold,  0,   0,   0   ,VFLAGNONE,VF2NONE),
 /*  F:. */  PRIMACV(CFCODOT,  CONJ, jtvalenceerr1, jtfold,  0,   0,   0   ,VFLAGNONE,VF2NONE),
 /*  F:: */  PRIMACV(CFCOCO,  CONJ, jtvalenceerr1, jtfold,  0,   0,   0   ,VFLAGNONE,VF2NONE),
 /*  Z:  */  PRIMACV(CZCO,  VERB,  jtvalenceerr1, jtfoldZ,  RMAX,   RMAX,   RMAX   ,VFLAGNONE,VF2NONE),
