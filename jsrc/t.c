...
PRIM primtab[256] = {
 ...
 /*  ^: */  PRIMACV(CPOWOP,  CONJ, jtvalenceerr, jtpowop,  0,   0,   0   ,VFLAGNONE,VF2NONE),
 ...
 /*  ~  */  PRIMACV(CTILDE,  ADV,  jtswap,    jtvalenceerr,  0,   0,   0   ,VFLAGNONE,VF2NONE),
 /*  ~. */  PRIMACV(CNUB,    VERB, jtnub,     jtvalenceerr,  RMAX,RMAX,RMAX,VASGSAFE|VJTFLGOK1,VF2NONE),
 ...
 /*  .  */  PRIMACV(CDOT,    CONJ, jtvalenceerr, jtdot,    0,   0,   0   ,VFLAGNONE,VF2NONE),
 /*  :  */  PRIMACV(CCOLON,  CONJ, jtvalenceerr, jtcolon,  0,   0,   0   ,VFLAGNONE,VF2NONE),
 /*  :. */  PRIMACV(COBVERSE,CONJ, jtvalenceerr, jtobverse,0,   0,   0   ,VFLAGNONE,VF2NONE),
 /*  :: */  PRIMACV(CADVERSE,CONJ, jtvalenceerr, jtadverse,0,   0,   0   ,VFLAGNONE,VF2NONE),
 ...
 /*  ;. */  PRIMACV(CCUT,    CONJ, jtvalenceerr,        jtcut,    0,   0,   0   ,VFLAGNONE,VF2NONE),
 ...
 /*  !. */  PRIMACV(CFIT,    CONJ, jtvalenceerr, jtfit,    0,   0,   0   ,VASGSAFE,VF2NONE),
 /*  !: */  PRIMACV(CIBEAM,  CONJ, jtvalenceerr, jtforeign,0,   0,   0   ,VFLAGNONE,VF2NONE),
 /*  /  */  PRIMACV(CSLASH,  ADV,  jtslash,   jtvalenceerr, 0,   0,   0   ,VIRS1,VF2NONE),
 /*  /. */  PRIMACV(CSLDOT,  ADV,  jtsldot,   jtvalenceerr, 0,   0,   0   ,VFLAGNONE,VF2NONE),
 /*  /: */  PRIMACV(CGRADE,  VERB, jtgrade1,  jtgrade2, RMAX,RMAX,RMAX,VASGSAFE|VIRS1|VIRS2|VJTFLGOK2,VF2NONE),
 /*  /.. */  PRIMACV(CSLDOTDOT,  ADV,  jtsldotdot,   jtvalenceerr, 0,   0,   0   ,VFLAGNONE,VF2NONE),
 /*  \  */  PRIMACV(CBSLASH, ADV,  jtbslash,  jtvalenceerr, 0,   0,   0   ,VIRS1,VF2NONE),
 /*  \. */  PRIMACV(CBSDOT,  ADV,  jtbsdot,   jtvalenceerr, 0,   0,   0   ,VIRS1,VF2NONE),
 ...
 /*  [: */  PRIMACV(CCAP,    VERB, jtvalenceerr,jtvalenceerr, RMAX,RMAX,RMAX,VFLAGNONE,VF2NONE),   // not ASGSAFE since used for not-yet-defined names
 ...
 /*  {: */  PRIMACV(CTAIL,   VERB, jttail,    jtvalenceerr,  RMAX,RMAX,RMAX,VASGSAFE|VIRS1|VJTFLGOK1,VF2NONE),
 /*  }  */  PRIMACV(CRBRACE, ADV,  jtamend,   jtvalenceerr, 0,   0,   0   ,VASGSAFE|VJTFLGOK2,VF2NONE),
 /*  }* */  PRIMACV(CCASEV,  VERB, jtcasev,   jtvalenceerr, RMAX,RMAX,RMAX,VFLAGNONE,VF2NONE),   // f2 gets filled in with pointer to a name when this is used
 /*  }. */  PRIMACV(CBEHEAD, VERB, jtbehead,  jtdrop,   RMAX,1,   RMAX,VASGSAFE|VIRS1|VIRS2|VJTFLGOK1|VJTFLGOK2,VF2NONE),  // alias CDROP
 /*  }: */  PRIMACV(CCTAIL,  VERB, jtcurtail, jtvalenceerr, RMAX,RMAX,RMAX,VASGSAFE|VIRS1|VJTFLGOK1,VF2NONE),
 /*  "  */  PRIMACV(CQQ,     CONJ, jtvalenceerr, jtqq,     0,   0,   0   ,VFLAGNONE,VF2NONE),
 ...
 /*  `  */  PRIMACV(CGRAVE,  CONJ, jtvalenceerr, jttie,    0,   0,   0   ,VFLAGNONE,VF2NONE),
 /*  `. */       /* undefined */
 /*  `: */  PRIMACV(CGRCO,   CONJ, jtvalenceerr, jtevger,  0,   0,   0   ,VFLAGNONE,VF2NONE),
 /*  @  */  PRIMACV(CAT,     CONJ, jtvalenceerr, jtatop,   0,   0,   0   ,VFLAGNONE,VF2NONE),
 /*  @. */  PRIMACV(CATDOT,  CONJ, jtvalenceerr, jtagendai, 0,   0,   0   ,VFLAGNONE,VF2NONE),
 /*  @: */  PRIMACV(CATCO,   CONJ, jtvalenceerr, jtatco,   0,   0,   0   ,VFLAGNONE,VF2NONE),
 /*  &  */  PRIMACV(CAMP,    CONJ, jtvalenceerr, jtamp,    0,   0,   0   ,VFLAGNONE,VF2NONE),
 /*  &. */  PRIMACV(CUNDER,  CONJ, jtvalenceerr, jtunder,  0,   0,   0   ,VFLAGNONE,VF2NONE),
 /*  &: */  PRIMACV(CAMPCO,  CONJ, jtvalenceerr,  jtampco,  0,   0,   0   ,VFLAGNONE,VF2NONE),
 ...
 /* }:: */  PRIMACV(CEMEND,  ADV,  jtemend,   jtvalenceerr,  0,   0,   0   ,VFLAGNONE,VF2NONE),
 /* &.: */  PRIMACV(CUNDCO,  CONJ, jtvalenceerr, jtundco,  0,   0,   0   ,VFLAGNONE,VF2NONE),
 /*  a. */       /* see above */
 /*  a: */       /* see above */
 /*  A. */  PRIMACV(CATOMIC, VERB, jtadot1,   jtadot2,  1,   0,   RMAX,VASGSAFE,VF2NONE),
 /*  b. */  PRIMACV(CBDOT,   ADV,  jtbdot,    jtvalenceerr, 0,   0,   0   ,VASGSAFE,VF2NONE),
 ...
 /*  E. */  PRIMACV(CEBAR,   VERB, jtvalenceerr, jtebar,   0,   RMAX,RMAX,VASGSAFE,VF2WILLOPEN2A|VF2WILLOPEN2W),
 /*  f. */  PRIMACV(CFIX,    ADV,  jtfix,     jtvalenceerr, 0,   0,   0   ,VFLAGNONE,VF2NONE),
 /*  H. */  PRIMACV(CHGEOM,  CONJ, jtvalenceerr, jthgeom,  0,   0,   0   ,VISATOMIC1|VASGSAFE,VF2NONE),
 ...
 /*  S: */  PRIMACV(CSCAPCO, CONJ, jtvalenceerr, jtscapco, 0,   0,   0   ,VFLAGNONE,VF2NONE),
 /*  t. */  PRIMACV(CTDOT,   CONJ, jtvalenceerr, jttdot, 0,   0,   0   ,VFLAGNONE,VF2NONE),
 /*  T. */  PRIMACV(CTCAPDOT, VERB, jttcapdot1, jttcapdot2, RMAX, RMAX,  RMAX   ,VFLAGNONE,VF2NONE),
 ...
 /*  F.  */  PRIMACV(CFDOT,  CONJ, jtvalenceerr, jtfold,  0,   0,   0   ,VFLAGNONE,VF2NONE),
 /*  F.. */  PRIMACV(CFDOTDOT,  CONJ, jtvalenceerr, jtfold,  0,   0,   0   ,VFLAGNONE,VF2NONE),
 /*  F.: */  PRIMACV(CFDOTCO,  CONJ, jtvalenceerr, jtfold,  0,   0,   0   ,VFLAGNONE,VF2NONE),
 /*  F:  */  PRIMACV(CFCO,  CONJ, jtvalenceerr, jtfold,  0,   0,   0   ,VFLAGNONE,VF2NONE),
 /*  F:. */  PRIMACV(CFCODOT,  CONJ, jtvalenceerr, jtfold,  0,   0,   0   ,VFLAGNONE,VF2NONE),
 /*  F:: */  PRIMACV(CFCOCO,  CONJ, jtvalenceerr, jtfold,  0,   0,   0   ,VFLAGNONE,VF2NONE),
