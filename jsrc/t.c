...
PRIM primtab[256] = {
 ...
 /*  ,  */  PRIMACV(CCOMMA,  VERB, jtravel,   jtapip,   RMAX,RMAX,RMAX,VASGSAFE|VIRS1|VIRS2|VJTFLGOK1|VJTFLGOK2,VF2WILLOPEN1PROP),  // scaf VF2WILLOPEN2?PROP if it doesn't EPILOG
 ...
 /*  ;  */  PRIMACV(CSEMICO, VERB, jtraze,    jtlink,   RMAX,RMAX,RMAX,VASGSAFE|VJTFLGOK2,VF2USESITEMCOUNT1|VF2WILLOPEN1),   // WILLOPEN2WPROP if not recursive & no EPILOG
