...
B jtpinit(J jt){A t;C*s;
 ...
 /*  =  */  pdef(CEQ,     VERB, jtsclass,  jteq,     RMAX,0,   0   ,0);
 /*  =. */       /* see above */
 /*  =: */       /* see above */
 /*  <  */  pdef(CBOX,    VERB, jtbox,     jtlt,     RMAX,0,   0   ,VINPLACEOK2);
 /*  <. */  pdef(CFLOOR,  VERB, jtfloor1,  jtminimum,0,   0,   0   ,0);
 /*  <: */  pdef(CLE,     VERB, jtdecrem,  jtle,     0,   0,   0   ,0);
 /*  >  */  pdef(COPE,    VERB, jtope,     jtgt,     0,   0,   0   ,0);
 /*  >. */  pdef(CCEIL,   VERB, jtceil1,   jtmaximum,0,   0,   0   ,0);
 /*  >: */  pdef(CGE,     VERB, jtincrem,  jtge,     0,   0,   0   ,0);
 /*  +  */  pdef(CPLUS,   VERB, jtconjug,  jtplus,   0,   0,   0   ,VINPLACEOK2);
 /*  +. */  pdef(CPLUSDOT,VERB, jtrect,    jtgcd,    0,   0,   0   ,0);
 /*  +: */  pdef(CPLUSCO, VERB, jtduble,   jtnor,    0,   0,   0   ,0);
 /*  *  */  pdef(CSTAR,   VERB, jtsignum,  jttymes,  0,   0,   0   ,0);
 /*  *. */  pdef(CSTARDOT,VERB, jtpolar,   jtlcm,    0,   0,   0   ,0);
 /*  *: */  pdef(CSTARCO, VERB, jtsquare,  jtnand,   0,   0,   0   ,0);
 /*  -  */  pdef(CMINUS,  VERB, jtnegate,  jtminus,  0,   0,   0   ,VINPLACEOK2);
 /*  -. */  pdef(CNOT,    VERB, jtnot,     jtless,   0,   RMAX,RMAX,0);
 /*  -: */  pdef(CHALVE,  VERB, jthalve,   jtmatch,  0,   RMAX,RMAX,0);
 /*  %  */  pdef(CDIV,    VERB, jtrecip,   jtdivide, 0,   0,   0   ,0);
 ...
 /*  ~: */  pdef(CNE,     VERB, jtnubsieve,jtne,     RMAX,0,   0   ,0);
