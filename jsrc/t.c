...
PRIM primtab[256] = {
 ...
 /*  -  */  PRIMATOMIC2(CMINUS,CMINUS,  VERB, jtnegate,  jtatomic2,  0,   0,   0   ,VISATOMIC1|VFUSEDOK2|VIRS2|VASGSAFE|VJTFLGOK1|VJTFLGOK2,VF2NONE|VF2PRIM),
 ...
 /*  $: */  PRIMACV(CSELF,   VERB, jtself1,   jtself2,  RMAX,RMAX,RMAX,VFLAGNONE,VF2NONE|VF2PRIM),
 ...
 /*  q: */  PRIMACV(CQCO,    VERB, jtfactor,  jtqco2,   0,   0,   0   ,VISATOMIC1|VASGSAFE,VF2NONE|VF2PRIM),
