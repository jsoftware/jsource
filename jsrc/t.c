...
#define PRIMASSIGN(idda,idd,t,f0,f1,f,g,h,initpm1,initpm2,rm,rl,rr,vflg,vflg2,an,ar,lcc) \
 ={{0xdeadbeefdeadbeef,(t)&TRAVERSIBLE,0,(t),ACPERMANENT,0xdeadbeefdeadbeef,(ar)},{{.valencefns={f0,f1},.fgh={f,g,h},.localuse={initpm1,initpm2},.flag=(vflg),.flag2=(vflg2),.lrr=(RANK2T)((rl<<RANKTX)+rr),.mr=(RANKT)rm,.id=idd,.lu2.lc=lcc}}}
...
PRIM dsCMINUS_NOT PRIMASSIGN(CMINUS,CMINUS,  VERB, 0,  jtatomic2,  0,0,0, .lu1.uavandx=0,VA2CMINUS*sizeof(VA),  0,0,0   ,VFUSEDOK2|VIRS2|VASGSAFE|VWASUNARY|VUNARYCODE0,VF2NONE|VF2PRIM,0,0,VA2CMINUS);
PRIM dsCMINUS_NEG PRIMASSIGN(CMINUS,CMINUS,  VERB, 0,  jtatomic2,  0,0,0, .lu1.uavandx=0,VA2CMINUS*sizeof(VA),  0,0,0   ,VFUSEDOK2|VIRS2|VASGSAFE|VWASUNARY|VUNARYCODE1,VF2NONE|VF2PRIM,0,0,VA2CMINUS);
PRIM dsCMINUS_DEC PRIMASSIGN(CMINUS,CMINUS,  VERB, 0,  jtatomic2,  0,0,0, .lu1.uavandx=0,VA2CMINUS*sizeof(VA),  0,0,0   ,VFUSEDOK2|VIRS2|VASGSAFE|VWASUNARY|VUNARYCODE2,VF2NONE|VF2PRIM,0,0,VA2CMINUS);
PRIM dsCPLUS_INC PRIMASSIGN(CPLUS,CPLUS,  VERB, 0,  jtatomic2,  0,0,0, .lu1.uavandx=0,VA2CPLUS*sizeof(VA),  0,0,0   ,VFUSEDOK2|VIRS2|VASGSAFE|VWASUNARY|VUNARYCODE0,VF2NONE|VF2PRIM,0,0,VA2CPLUS);
PRIM dsCSTAR_DUBL PRIMASSIGN(CSTAR,CSTAR,  VERB, 0,  jtatomic2,  0,0,0, .lu1.uavandx=0,VA2CSTAR*sizeof(VA),  0,0,0   ,VFUSEDOK2|VIRS2|VASGSAFE|VWASUNARY|VUNARYCODE0,VF2NONE|VF2PRIM,0,0,VA2CSTAR);
PRIM dsCSTAR_SQUARE PRIMASSIGN(CSTAR,CSTAR,  VERB, 0,  jtatomic2,  0,0,0, .lu1.uavandx=0,VA2CSTAR*sizeof(VA),  0,0,0   ,VFUSEDOK2|VIRS2|VASGSAFE|VWASUNARY|VUNARYCODE1,VF2NONE|VF2PRIM,0,0,VA2CSTAR);
PRIM dsCSTAR_HALVE PRIMASSIGN(CSTAR,CSTAR,  VERB, 0,  jtatomic2,  0,0,0, .lu1.uavandx=0,VA2CSTAR*sizeof(VA),  0,0,0   ,VFUSEDOK2|VIRS2|VASGSAFE|VWASUNARY|VUNARYCODE2,VF2NONE|VF2PRIM,0,0,VA2CSTAR);
PRIM dsCSTAR_CIRCLE PRIMASSIGN(CSTAR,CSTAR,  VERB, 0,  jtatomic2,  0,0,0, .lu1.uavandx=0,VA2CSTAR*sizeof(VA),  0,0,0   ,VFUSEDOK2|VIRS2|VASGSAFE|VWASUNARY|VUNARYCODE3,VF2NONE|VF2PRIM,0,0,VA2CSTAR);
PRIM dsCDIV_RECIP PRIMASSIGN(CDIV,CDIV,  VERB, 0,  jtatomic2,  0,0,0, .lu1.uavandx=0,VA2CDIV*sizeof(VA),  0,0,0   ,VFUSEDOK2|VIRS2|VASGSAFE|VWASUNARY|VUNARYCODE0,VF2NONE|VF2PRIM,0,0,VA2CDIV);
PRIM dsCDIV_HALVE PRIMASSIGN(CDIV,CDIV,  VERB, 0,  jtatomic2,  0,0,0, .lu1.uavandx=0,VA2CDIV*sizeof(VA),  0,0,0   ,VFUSEDOK2|VIRS2|VASGSAFE|VWASUNARY|VUNARYCODE1,VF2NONE|VF2PRIM,0,0,VA2CDIV);
...
PRIM primtab[256] = {
 ...
 /*  bw */  PRIMATOMIC2(CBW0000,CBW0000, VERB, jtbitwise1,  jtatomic2,   RMAX,0,   0   ,VISATOMIC1|VFUSEDOK2|VIRS2|VASGSAFE,VF2NONE|VF2PRIM),
 /*  bw */  PRIMATOMIC2(CBW0001,CBW0001, VERB, jtbitwise1,  jtatomic2,   RMAX,0,   0   ,VISATOMIC1|VFUSEDOK2|VIRS2|VASGSAFE,VF2NONE|VF2PRIM),
 /*  bw */  PRIMATOMIC2(CBW0010,CBW0010, VERB, jtbitwise1,  jtatomic2,   RMAX,0,   0   ,VISATOMIC1|VFUSEDOK2|VIRS2|VASGSAFE,VF2NONE|VF2PRIM),
 /*  bw */  PRIMATOMIC2(CBW0011,CBW0011, VERB, jtbitwise1,  jtatomic2,   RMAX,0,   0   ,VISATOMIC1|VFUSEDOK2|VIRS2|VASGSAFE,VF2NONE|VF2PRIM),
 /*  bw */  PRIMATOMIC2(CBW0100,CBW0100, VERB, jtbitwise1,  jtatomic2,   RMAX,0,   0   ,VISATOMIC1|VFUSEDOK2|VIRS2|VASGSAFE,VF2NONE|VF2PRIM),
 /*  bw */  PRIMATOMIC2(CBW0101,CBW0101, VERB, jtbitwise1,  jtatomic2,   RMAX,0,   0   ,VISATOMIC1|VFUSEDOK2|VIRS2|VASGSAFE,VF2NONE|VF2PRIM),
 /*  bw */  PRIMATOMIC2(CBW0110,CBW0110, VERB, jtbitwise1,  jtatomic2,   RMAX,0,   0   ,VISATOMIC1|VFUSEDOK2|VIRS2|VASGSAFE,VF2NONE|VF2PRIM),
 /*  bw */  PRIMATOMIC2(CBW0111,CBW0111, VERB, jtbitwise1,  jtatomic2,   RMAX,0,   0   ,VISATOMIC1|VFUSEDOK2|VIRS2|VASGSAFE,VF2NONE|VF2PRIM),
 /*  bw */  PRIMATOMIC2(CBW1000,CBW1000, VERB, jtbitwise1,  jtatomic2,   RMAX,0,   0   ,VISATOMIC1|VFUSEDOK2|VIRS2|VASGSAFE,VF2NONE|VF2PRIM),
 /*  bw */  PRIMATOMIC2(CBW1001,CBW1001, VERB, jtbitwise1,  jtatomic2,   RMAX,0,   0   ,VISATOMIC1|VFUSEDOK2|VIRS2|VASGSAFE,VF2NONE|VF2PRIM),
 /*  bw */  PRIMATOMIC2(CBW1010,CBW1010, VERB, jtbitwise1,  jtatomic2,   RMAX,0,   0   ,VISATOMIC1|VFUSEDOK2|VIRS2|VASGSAFE,VF2NONE|VF2PRIM),
 /*  bw */  PRIMATOMIC2(CBW1011,CBW1011, VERB, jtbitwise1,  jtatomic2,   RMAX,0,   0   ,VISATOMIC1|VFUSEDOK2|VIRS2|VASGSAFE,VF2NONE|VF2PRIM),
 /*  bw */  PRIMATOMIC2(CBW1100,CBW1100, VERB, jtbitwise1,  jtatomic2,   RMAX,0,   0   ,VISATOMIC1|VFUSEDOK2|VIRS2|VASGSAFE,VF2NONE|VF2PRIM),
 /*  bw */  PRIMATOMIC2(CBW1101,CBW1101, VERB, jtbitwise1,  jtatomic2,   RMAX,0,   0   ,VISATOMIC1|VFUSEDOK2|VIRS2|VASGSAFE,VF2NONE|VF2PRIM),
 /*  bw */  PRIMATOMIC2(CBW1110,CBW1110, VERB, jtbitwise1,  jtatomic2,   RMAX,0,   0   ,VISATOMIC1|VFUSEDOK2|VIRS2|VASGSAFE,VF2NONE|VF2PRIM),
 /*  bw */  PRIMATOMIC2(CBW1111,CBW1111, VERB, jtbitwise1,  jtatomic2,   RMAX,0,   0   ,VISATOMIC1|VFUSEDOK2|VIRS2|VASGSAFE,VF2NONE|VF2PRIM),
 /*  bwrot */  PRIMATOMIC2(CBW10000,CBW10000, VERB, jtvalenceerr,  jtatomic2,   RMAX,0,   0   ,VISATOMIC1|VFUSEDOK2|VIRS2|VASGSAFE,VF2NONE|VF2PRIM),
 /*  bwlsl */  PRIMATOMIC2(CBW10001,CBW10001, VERB, jtvalenceerr,  jtatomic2,   RMAX,0,   0   ,VISATOMIC1|VFUSEDOK2|VIRS2|VASGSAFE,VF2NONE|VF2PRIM),
 /*  bwasl */  PRIMATOMIC2(CBW10010,CBW10010, VERB, jtvalenceerr,  jtatomic2,   RMAX,0,   0   ,VISATOMIC1|VFUSEDOK2|VIRS2|VASGSAFE,VF2NONE|VF2PRIM),
 /*  =  */  PRIMATOMIC2(CEQ,CEQ,     VERB, jtsclass,  jtatomic2,     RMAX,0,   0   ,VFUSEDOK2|VASGSAFE|VIRS2,VF2NONE|VF2PRIM),
 /*  =. */       /* see above */
 /*  =: */       /* see above */
 /*  <  */  PRIMATOMIC2g(CLT,    VERB, jtbox,     jtatomic2,     RMAX,0,   0   ,VASGSAFE|VFUSEDOK2|VIRS1|VIRS2,VF2BOXATOP1|VF2PRIM,ds(CRIGHT)),  // alias CLT
 /*  <. */  PRIMATOMIC12(CMIN,  VERB, jtatomic1,  jtatomic2,0,   0,   0   ,VISATOMIC1|VFUSEDOK2|VIRS2|VASGSAFE,VF2NONE|VF2PRIM),  // alias CMIN
 /*  <: */  PRIMATOMIC2(CLE,CLE,     VERB, jtdecrem,  jtatomic2,     0,   0,   0   ,VISATOMIC1|VFUSEDOK2|VIRS2|VASGSAFE,VF2NONE|VF2PRIM),
 /*  >  */  PRIMATOMIC2(CGT,CGT,    VERB, jtope,     jtatomic2,     0,   0,   0   ,VFUSEDOK2|VASGSAFE|VIRS2,VF2WILLOPEN1|VF2PRIM),  // alias CGT
 /*  >. */  PRIMATOMIC12(CMAX,   VERB, jtatomic1,   jtatomic2,0,   0,   0   ,VISATOMIC1|VFUSEDOK2|VIRS2|VASGSAFE,VF2NONE|VF2PRIM),  // alias CMAX
 /*  >: */  PRIMATOMIC2(CGE,CGE,     VERB, jtincrem,  jtatomic2,     0,   0,   0   ,VISATOMIC1|VFUSEDOK2|VIRS2|VASGSAFE,VF2NONE|VF2PRIM),
 /*  +  */  PRIMATOMIC12(CPLUS,   VERB, jtatomic1,  jtatomic2,   0,   0,   0   ,VISATOMIC1|VFUSEDOK2|VIRS2|VASGSAFE,VF2NONE|VF2PRIM),
 /*  +. */  PRIMATOMIC2(CPLUSDOT,CPLUSDOT,VERB, jtrect,    jtatomic2,    0,   0,   0   ,VISATOMIC1|VFUSEDOK2|VIRS2|VASGSAFE,VF2NONE|VF2PRIM),
 /*  +: */  PRIMATOMIC2(CPLUSCO,CPLUSCO, VERB, jtduble,   jtatomic2,    0,   0,   0   ,VISATOMIC1|VFUSEDOK2|VIRS2|VASGSAFE,VF2NONE|VF2PRIM),
 /*  *  */  PRIMATOMIC12(CSTAR,   VERB, jtatomic1,  jtatomic2,  0,   0,   0   ,VISATOMIC1|VFUSEDOK2|VIRS2|VASGSAFE,VF2NONE|VF2PRIM),
 /*  *. */  PRIMATOMIC2(CSTARDOT,CSTARDOT,VERB, jtpolar,   jtatomic2,    0,   0,   0   ,VISATOMIC1|VFUSEDOK2|VIRS2|VASGSAFE,VF2NONE|VF2PRIM),
 /*  *: */  PRIMATOMIC2(CSTARCO,CSTARCO, VERB, jtsquare,  jtatomic2,   0,   0,   0   ,VISATOMIC1|VFUSEDOK2|VIRS2|VASGSAFE,VF2NONE|VF2PRIM),
 /*  -  */  PRIMATOMIC2UV(CMINUS,CMINUS,VA1CNEG-VA1ORIGIN,  VERB, jtnegate,  jtatomic2,  0,   0,   0   ,VISATOMIC1|VFUSEDOK2|VIRS2|VASGSAFE,VF2NONE|VF2PRIM),
 /*  -. */  PRIMACV(CNOT,    VERB, jtnot,     jtless,   0,   RMAX,RMAX,VISATOMIC1|VASGSAFE|((7+(((ILESS-II0EPS)&0xf)<<3))&-SY_64),VF2NONE|VF2PRIM),  // native compound allowing &n - 64-bit only
 /*  -: */  PRIMACV(CHALVE,  VERB, jthalve,   jtmatch,  0,   RMAX,RMAX,VISATOMIC1|VIRS2|VASGSAFE,VF2NONE|VF2PRIM),  // alias CMATCH
 /*  %  */  PRIMATOMIC2UV(CDIV,CDIV,VA1CRECIP-VA1ORIGIN,    VERB, jtrecip,   jtatomic2, 0,   0,   0   ,VISATOMIC1|VFUSEDOK2|VIRS2|VASGSAFE,VF2NONE|VF2PRIM),
 /*  %. */  PRIMACV(CDOMINO, VERB, jtminv,    jtmdiv,   2,   RMAX,2   ,VASGSAFE,VF2NONE|VF2PRIM),
 /*  %: */  PRIMATOMIC1(CROOT,   VERB, jtatomic1,  jtroot,   0,   0,   0   ,VISATOMIC1|VASGSAFE,VF2NONE|VF2PRIM),
 /*  ^  */  PRIMATOMIC12(CEXP,    VERB, jtatomic1,   jtexpn2,  0,   0,   0   ,VISATOMIC1|VFUSEDOK2|VIRS2|VASGSAFE,VF2NONE|VF2PRIM),
 /*  ^. */  PRIMATOMIC1(CLOG,    VERB, jtatomic1,  jtlogar2, 0,   0,   0   ,VISATOMIC1|VASGSAFE,VF2NONE|VF2PRIM),
 /*  ^: */  PRIMACV(CPOWOP,  CONJ, jtvalenceerr, jtpowop,  0,   0,   0   ,VFLAGNONE,VF2NONE|VF2PRIM|VF2NAMELESS),
 /*  $  */  PRIMACV(CDOLLAR, VERB, jtshapex,  jtreitem, RMAX,1,   RMAX,VASGSAFE|VIRS2,VF2NONE|VF2PRIM),
 /*  $. */  PRIMACV(CSPARSE, VERB, jtsparse1, jtsparse2,RMAX,RMAX,RMAX,VASGSAFE,VF2NONE|VF2PRIM),
 /*  $: */  PRIMACV(CSELF,   VERB, jtself12,   jtself12,  RMAX,RMAX,RMAX,VFLAGNONE,VF2NONE|VF2PRIM),
 /*  ~  */  PRIMACV(CTILDE,  ADV,  jtswap,    jtvalenceerr,  0,   0,   0   ,VFLAGNONE,VF2NONE|VF2PRIM|VF2NAMELESS),
 /*  ~. */  PRIMACV(CNUB,    VERB, jtnub,     jtvalenceerr,  RMAX,RMAX,RMAX,VASGSAFE,VF2NONE|VF2PRIM),
 /*  ~: */  PRIMATOMIC2(CNE,CNE,     VERB, jtnubsieve,jtatomic2,     RMAX,0,   0   ,VFUSEDOK2|VASGSAFE|VIRS1|VIRS2,VF2WILLOPEN1|VF2PRIM),
 /*  |  */  PRIMATOMIC12(CSTILE,  VERB, jtatomic1,     jtresidue,0,   0,   0   ,VISATOMIC1|VFUSEDOK2|VIRS2|VASGSAFE,VF2NONE|VF2PRIM),
 /*  |. */  PRIMACV(CREV,    VERB, jtreverse, jtrotate, RMAX,1,   RMAX,VASGSAFE|VIRS1|VIRS2,VF2WILLOPEN1PROP|VF2PRIM),   // alias CROT
 /*  |: */  PRIMACV(CCANT,   VERB, jtcant1,   jtcant2,  RMAX,1,   RMAX,VASGSAFE|VIRS1|VIRS2,VF2WILLOPEN1PROP|VF2WILLOPEN2A|VF2PRIM),
 ...
 /*  ,  */  PRIMACV(CCOMMA,  VERB, jtravel,   jtapip,   RMAX,RMAX,RMAX,VASGSAFE|VIRS1|VIRS2,VF2WILLOPEN1PROP|VF2PRIM),  // could VF2WILLOPEN2?PROP but sparse code may EPILOG
 /*  ,. */  PRIMACV(CCOMDOT, VERB, jttable,   jtstitch, RMAX,RMAX,RMAX,VASGSAFE|VIRS1,VF2NONE|VF2PRIM),
 /*  ,: */  PRIMACV(CLAMIN,  VERB, jtlamin1,  jtlamin2, RMAX,RMAX,RMAX,VASGSAFE|VIRS1|VIRS2,VF2NONE|VF2PRIM),
 /*  ;  */  PRIMACV(CSEMICO, VERB, jtraze,    jtjlink,  RMAX,RMAX,RMAX,VASGSAFE,VF2USESITEMCOUNT1|VF2WILLOPEN1|VF2WILLOPEN2WPROP|VF2PRIM),
 ...
 /*  #  */  PRIMACV(CPOUND,  VERB, jttally,   jtrepeat, RMAX,1,   RMAX,VASGSAFE|VIRS2,VF2NONE|VF2PRIM),
 ...
 /*  !  */  PRIMATOMIC12(CBANG,   VERB, jtatomic1, jtatomic2,  0,   0,   0   ,VISATOMIC1|VFUSEDOK2|VIRS2|VASGSAFE,VF2NONE|VF2PRIM),
 ...
 /*  /: */  PRIMACV(CGRADE,  VERB, jtgrade1,  jtgrade2, RMAX,RMAX,RMAX,VASGSAFE|VIRS1|VIRS2,VF2NONE|VF2PRIM),
 ...
 /*  \: */  PRIMACV(CDGRADE, VERB, jtdgrade1, jtdgrade2,RMAX,RMAX,RMAX,VASGSAFE|VIRS1|VIRS2,VF2NONE|VF2PRIM),
 /*  [  */  PRIMACV(CLEFT,   VERB, jtright1,  jtleft2,  RMAX,RMAX,RMAX,VASGSAFE|VIRS1|VIRS2|VISATOMIC1,VF2WILLOPEN1PROP|VF2WILLOPEN2APROP|VF2PRIM),
 /*  [. */  PRIMACV(CLEV,    CONJ,  0,   jtlev, 0,   0,   0   ,VASGSAFE,VF2NONE|VF2PRIM|VF2NAMELESS),
 ...
 /*  ]  */  PRIMACV(CRIGHT,  VERB, jtright1,  jtright2, RMAX,RMAX,RMAX,VASGSAFE|VIRS1|VIRS2|VISATOMIC1,VF2WILLOPEN1PROP|VF2WILLOPEN2WPROP|VF2PRIM),
 /*  ]. */  PRIMACV(CDEX,    CONJ,  0,   jtdex, 0,   0,   0   ,VASGSAFE,VF2NONE|VF2PRIM|VF2NAMELESS),
 /*  ]. */  PRIMACV(CIDENT,  ADV,   jtlev,   0, 0,   0,   0   ,VASGSAFE,VF2NONE|VF2PRIM|VF2NAMELESS),
 /*  {  */  PRIMACV(CLBRACE, VERB, jtcatalog, jtfrom,   1,   0,   RMAX,VASGSAFE|VIRS2,VF2WILLOPEN2A|VF2PRIM),
 /*  {. */  PRIMACV(CHEAD,   VERB, jthead,    jttake,   RMAX,1,   RMAX,VASGSAFE|VIRS1|VIRS2,VF2NONE|VF2PRIM),  // alias CTAKE
 /*  {: */  PRIMACV(CTAIL,   VERB, jttail,    jtvalenceerr,  RMAX,RMAX,RMAX,VASGSAFE|VIRS1,VF2NONE|VF2PRIM),
 /*  }  */  PRIMACV(CRBRACE, ADV,  jtamend,   jtvalenceerr, 0,   0,   0   ,VASGSAFE,VF2NONE|VF2PRIM|VF2NAMELESS),
 ...
 /*  }. */  PRIMACV(CBEHEAD, VERB, jtbehead,  jtdrop,   RMAX,1,   RMAX,VASGSAFE|VIRS1|VIRS2,VF2NONE|VF2PRIM),  // alias CDROP
 /*  }: */  PRIMACV(CCTAIL,  VERB, jtcurtail, jtvalenceerr, RMAX,RMAX,RMAX,VASGSAFE|VIRS1,VF2NONE|VF2PRIM),
 ...
 /*  ?: */       /* undefined */
 /* {:: */  PRIMACV(CFETCH,  VERB, jtmap,     jtfetch,  RMAX,1,   RMAX,VASGSAFE,VF2NONE|VF2PRIM),
// unsupported /* }:: */  PRIMACV(CEMEND,  ADV,  jtemend,   jtvalenceerr,  0,   0,   0   ,VFLAGNONE,VF2NONE|VF2PRIM|VF2NAMELESS),
 ...
 /*  o. */  PRIMATOMIC12(CCIRCLE, VERB, jtpix, jtatomic2, 0,   0,   0   ,VISATOMIC1|VFUSEDOK2|VIRS2|VASGSAFE,VF2NONE|VF2PRIM),
 /*  p. */  PRIMACV(CPOLY,   VERB, jtpoly1,   jtpoly2,  1,   1,   0   ,VASGSAFE|VIRS2,VF2NONE|VF2PRIM),
 ...
 /*  q: */  PRIMACV(CQCO,    VERB, jtfactor,  jtqco2,   RMAX,   0,   0   ,VASGSAFE,VF2NONE|VF2PRIM),
