...
B jtpinit(J jt){A t;C*s;
 ...
 /*  <. */  pdef(CFLOOR,  VERB, jtfloor1,  jtminimum,0,   0,   0   ,VINPLACEOK1+VINPLACEOK2);
 /*  <: */  pdef(CLE,     VERB, jtdecrem,  jtle,     0,   0,   0   ,VINPLACEOK1+VINPLACEOK2);
 /*  >  */  pdef(COPE,    VERB, jtope,     jtgt,     0,   0,   0   ,VINPLACEOK2);
 /*  >. */  pdef(CCEIL,   VERB, jtceil1,   jtmaximum,0,   0,   0   ,VINPLACEOK1+VINPLACEOK2);
 ...
 /*  +: */  pdef(CPLUSCO, VERB, jtduble,   jtnor,    0,   0,   0   ,VINPLACEOK1+VINPLACEOK2);
 /*  *  */  pdef(CSTAR,   VERB, jtsignum,  jttymes,  0,   0,   0   ,VINPLACEOK1+VINPLACEOK2);
 ...
 /*  %: */  pdef(CSQRT,   VERB, jtsqroot,  jtroot,   0,   0,   0   ,VINPLACEOK1);
 /*  ^  */  pdef(CEXP,    VERB, jtexpn1,   jtexpn2,  0,   0,   0   ,VINPLACEOK1+VINPLACEOK2);
 /*  ^. */  pdef(CLOG,    VERB, jtlogar1,  jtlogar2, 0,   0,   0   ,VINPLACEOK1);
 ...
 /*  |  */  pdef(CSTILE,  VERB, jtmag,     jtresidue,0,   0,   0   ,VINPLACEOK1);
 ...
 /*  !  */  pdef(CBANG,   VERB, jtfact,    jtoutof,  0,   0,   0   ,VINPLACEOK1+VINPLACEOK2);
 ...
 /*  n. */       /* see above */
 /*  o. */  pdef(CCIRCLE, VERB, jtpix,     jtcircle, 0,   0,   0   ,VINPLACEOK1);
