...
// obsolete    if(p!=q){if((p==0)!=(q==0))R 0; if(AK(p)!=AK(q))R 0; if(!((B (*)())jtmatchsub)(jt,p,q,0  MATCHSUBDEFAULTS))R 0; if(memcmp(CAV1(p),CAV1(q),AK(p)-AKXR(1)))R 0;}  // check boxes and tcesx.  the table is allocated with rank 0.
