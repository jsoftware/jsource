...
#define PRMALIGN(zzop,xy,fz,len) \
  UI alignreq=4-PEXT0((I)z,LGSZI,NPAR-1); /* alignment len, 1-4 */ \
...
#define PRMMASKLP(zzop,xy,fz) { \
  UI thisl=4-PEXT0((I)z,LGSZI,NPAR-1);  /* rem len, align len 1-4, clamped at len */ \
  NOUNROLL do { \
...
AHDR2(f,void,void,void){ I u,v;       \
 ...
 if(m<0){m=~m;                                             \
  ...
  DQ(PEXT0(m-1,LGSZI,NPAR-1), u=*(I*)x; v=*(I*)y; *(I*)z=pfx(u,v); x=(C*)x+SZI; y=(C*)y+SZI; z=(C*)z+SZI;);   \
  u=*(I*)x; v=*(I*)y; u=pfx(u,v); STOREBYTES(z,u,(-m)&(SZI-1));  \
 }else if(m&1){m>>=1;                      \
  DQU(n, \
   ...
   DQ(PEXT0(m-1,LGSZI,NPAR-1), v=*(I*)y; *(I*)z=pfx(u,v); y=(C*)y+SZI; z=(C*)z+SZI;)           \
   v=*(I*)y; u=pfx(u,v); STOREBYTES(z,u,(-m)&(SZI-1)); y=(I*)((UC*)y+(((m-1)&(SZI-1))+1)); z=(I*)((UC*)z+(((m-1)&(SZI-1))+1)); \
  ) \
 }else{m>>=1;  \
  DQU(n, \
   ...
   DQ(PEXT0(m-1,LGSZI,NPAR-1), u=*(I*)x; *(I*)z=pfx(u,v); x=(C*)x+SZI; z=(C*)z+SZI;)         \
   u=*(I*)x; u=pfx(u,v); STOREBYTES(z,u,(-m)&(SZI-1)); x=(I*)((UC*)x+(((m-1)&(SZI-1))+1)); z=(I*)((UC*)z+(((m-1)&(SZI-1))+1)); \
  ) \
 } \
 R EVOK; \
