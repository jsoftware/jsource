...
A jtssingleton(J jt, A a,A w,A self,RANK2T awr,RANK2T ranks){A z;
 ...
 case SSINGCASE(VA2CEXP-VA2CBW1111,SSINGBB): SSSTORE((I)SSRDB(a)|(I)!SSRDB(w),z,INT,I) R z;  // normal code produces B01
 ...
 case SSINGCASE(VA2CEXP-VA2CBW1111,SSINGIB): SSSTORE(SSRDB(w)?(D)SSRDI(a):1.0,z,FL,D) R z;
