...
// comparisons on qp floats: tolerant-only, then general
#define TEQE(u,v) TEQ((u).hi,(v).hi)
#define TNEE(u,v) TNE((u).hi,(v).hi)
#define TLTE(u,v) TLT((u).hi,(v).hi)
#define TLEE(u,v) TLE((u).hi,(v).hi)
#define TGTE(u,v) TGT((u).hi,(v).hi)
#define TGEE(u,v) TGE((u).hi,(v).hi)
#define EQE(u,v) ((jt->cct==1.0)?(u).hi==(v).hi&&(u).lo==(v).lo:TEQ((u).hi,(v).hi))
#define NEE(u,v) ((jt->cct==1.0)?(u).hi!=(v).hi||(u).lo!=(v).lo:TNE((u).hi,(v).hi))
