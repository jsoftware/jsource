...
#define COMPSPSS(f,T,e1init,esel)  \
 CF(f){I c,ia,ib,na,nb,p,*tv,wf,xc,*ya,*yb,yc,*yv;T e,e1,*xa,*xb,*xv;SORTSP * RESTRICT spblok=sortblok->sp;    \
  ...
  while(1){                                                                                              \
   ...
   switch(c){                                                                                            \
   case -1: DO(xc, if(xa[i] <(esel))R (int)PEXT0((I)sortblok->jt,JTDESCENDX,1)^1; else if(xa[i] >(esel))R (int)PEXT0((I)sortblok->jt,JTDESCENDX,1);) xa+=xc; ++ia;               break;  \
   case  1: DO(xc, if((esel)<xb[i] )R (int)PEXT0((I)sortblok->jt,JTDESCENDX,1)^1; else if((esel)>xb[i] )R (int)PEXT0((I)sortblok->jt,JTDESCENDX,1);)               xb+=xc; ++ib; break;  \
   case  0: DO(xc, if(xa[i] <xb[i] )R (int)PEXT0((I)sortblok->jt,JTDESCENDX,1)^1; else if(xa[i] >xb[i] )R (int)PEXT0((I)sortblok->jt,JTDESCENDX,1);) xa+=xc; ++ia; xb+=xc; ++ib;         \
 }}}
...
#define COMPSPDS(f,T,e1init,esel)  \
 CF(f){I c,ia,ib,n,na,nb,p,*tv,xc,*ya,*yb,yc,*yv;T e,e1,*xa,*xb,*xv;SORTSP * RESTRICT spblok=sortblok->sp;     \
  ...
  while(1){                                                                                              \
   ...
   switch(c){                                                                                            \
   case -1: DO(n, if(xa[i] <(esel))R (int)PEXT0((I)sortblok->jt,JTDESCENDX,1)^1; else if(xa[i] >(esel))R (int)PEXT0((I)sortblok->jt,JTDESCENDX,1);) xa+=xc; ++ia;               break;   \
   case  1: DO(n, if((esel)<xb[i] )R (int)PEXT0((I)sortblok->jt,JTDESCENDX,1)^1; else if((esel)>xb[i] )R (int)PEXT0((I)sortblok->jt,JTDESCENDX,1);)               xb+=xc; ++ib; break;   \
   case  0: DO(n, if(xa[i] <xb[i] )R (int)PEXT0((I)sortblok->jt,JTDESCENDX,1)^1; else if(xa[i] >xb[i] )R (int)PEXT0((I)sortblok->jt,JTDESCENDX,1);) xa+=xc; ++ia; xb+=xc; ++ib;          \
 }}}
