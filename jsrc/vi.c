...
static I hashallo(IH * RESTRICT hh,UI p,UI m,I md){
 ...
 if(!(md&IIMODFORCE0)){
  ...
  // in the amount of (new left index end-right index end-pyx m)*(width-currenthi).  We estimate future values to equal current ones.
...
static A jtnodupgrade(J jt,A a,I acr,I ac,I acn,I ad,I n,I m,B b,B bk){A*av,h,*u,*v;I*hi,*hu,*hv,l,m1,q;
 RZ(h=IRS1(jtgrade1,jt,a,acr,0L)); hv=AV(h)+bk*(m-1); av=AAV(a);
...
A jtindexofprehashed(J jtfg,A a,A w,A hs,A self){F12IP;A h,hi,*hv,x,z;AF fn;I ar,*as,at,c,f1,k,m,mode,n,
