...
printf("wi=%d ai=%d ar=%d\n",(int)wi,(int)ai,(int)ar);  // scaf
 if(unlikely(MIN(ai,wi)==0&&ar))RCA(a);  // if either arg empty, there's nothing to remove, return a, but atom must become a list
printf("after test\n"); // scaf
