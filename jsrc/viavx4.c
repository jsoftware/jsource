...
name##out: \
   if((fz)&0x8000){*(C*)zv=maskatend!=inv*15; zv=(C*)zv+1; \
    ...
    orign2+=(I)SHMSK8((fz)&0x1000?inv?0x4322111100000000:0x0000000011112234:inv?0x4010201030102010:0x0102010301020104,maskatend<<2,7); if((fz)&0x1000){orign2=n0-1-orign2; orign2=orign2<0?n0:orign2;} \
