...
#define CVCASE(a,b)     (8*PEXTNC(0xde8c,(a),7)+PEXTNC(0xde8c,(b),7))   // Must distinguish 0 2 3 4 6 7 9 10 13->4 3 1 0 2 5 7 7 6  11011110 10001100
...
// x I. y
DF2(jticap2){F12IP;A*av,*wv,z;C*uu,*vv;I ar,*as,at,b,c,ck,cm,ge,gt,j,k,m,n,p,q,r,t,wr,*ws,wt,* RESTRICT zv;I cc;
 ARGCHK2(a,w);
