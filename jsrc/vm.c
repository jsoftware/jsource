...
E f128toe(Sleef_quad w){
 UIL exp=SHMSK8(((UIL*)&w)[1],48,0x7fff);  // extract 15-bit biased SLEEF exponent
 ...
 IL ilo=SHMSK8(((IL*)&w)[0],8,0x000fffffffffffffLL);   // low significance of mantissa, bits 8-59 
