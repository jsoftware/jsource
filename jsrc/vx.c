...
F2(jtmdot){F12IP;A z=0;
 ...
 fdeffillall(z,VF2NAMELESS,CMDOT,VERB, fn1,fn2, a,w,h,VASGSAFE+VFIX, 0,0,0,fffv->localuse.lu0.modatomfn=modoptbl[fnx][nrecip==0],FAV(z)->localuse.lu1.mrecip=nrecip);
 R z;
}
