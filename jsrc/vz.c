...
ZF2(jtzgcd){D a,b;Z t,z,t1;I lim;
 ...
 if(SHMSK(0xf1f4,RrIi,1)){D zt=z.re; z.re=z.im; z.im=zt;}  // swap if re==0, or im!=0&(re>0!=im>0) 1111 0001 1111 0100
 R z;
}
...
DF1(jtexppi){F12IP;A z;B b;D r,th,y;I k;Z*v,t;
 ...
 R z;
revert:;
 R on1cell(jt,w,self);  // revert as if ^@:o.
}    /* special code for ^@o. */
