...
['p'-0x20]={0,CPOLY,CPCO},        ['q'-0x20]={0,0,CQCO},            ['r'-0x20]={0,CRDOT,0},           ['S'-0x20]={0,0,CSCAPCO},
...
[CDEX    ]=(UC)']'+DOT0,      [CIDENT ]=(UC)']'+CO0,        [CENQUEUE]=(UC)' ',[CCOLONE]=(UC)':',   // enqueue, colone have no spellin
...
[CRDOT   ]=(UC)'r'+DOT0,      [CSCAPCO ]=(UC)'S'+CO0,
...
void spellit(UC c,UC *s){
 ...
 s[0]=(C)spell; s[1]=(C)SHMSK(0x203a2e00,PEXT0(spell,8,0x3)<<3,~0); s[2]=(C)SHMSK(0x203a2e00,PEXT0(spell,10,0x3)<<3,~0);   // 00100000 00111010 00101110 00000000  for NUL . :, with overlap
}
