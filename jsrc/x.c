...
#define XPRIM(ps,fn1,fn2,flg1,flg2,m,lr,rr) \
 ...
 MN(128,19) XPRIM(VERB, jtmvmsparsee,  0,            VASGSAFE,VF2WILLOPEN1,RMAX,   RMAX,RMAX);
 ...
 MN(128,14) XPRIM(VERB, jtbatchop,   jtbatchop,            VASGSAFE,VF2WILLOPEN2A,RMAX,RMAX,RMAX);
 MN(128,22) XPRIM(VERB, 0,           jtqktupdate,   VASGSAFE,VF2WILLOPEN2A,RMAX,RMAX,RMAX);
...
// (2,9) reserved for messages from host OS
 ...
 MN(128,15) XPRIM(VERB, jtxxhash2,   jtxxhash2,    VASGSAFE,VF2NONE,RMAX,RMAX,RMAX);
