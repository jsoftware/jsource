...
F1(jttraceexf){F12IP;A z;
 ARGCHK1(w); ASSERT(1>=AR(w),EVRANK); RZ(z=(I)jt->usertracefn1&~3?drop(num(-1),jt->usertracefn1):sc((I)jt->usertracefn1)) // error if rank>1, set return to starting status (remove trailing NUL from fn)
...
F1(jttraceexc){F12IP;A z;
 ARGCHK1(w); ASSERT(1>=AR(w),EVRANK); RZ(z=(I)jt->usertracefn2&~3?drop(num(-1),jt->usertracefn2):sc((I)jt->usertracefn2)) // error if rank>1, set return to starting status (remove trailing NUL from fn)
 if(AN(w)){   // if w empty, skip the modification
  // user is setting the value
  if(AT(w)&LIT){     // set output file name
   ASSERT(' '!=CAV(w)[0],EVDOMAIN) ASSERT(0!=CAV(w)[0],EVDOMAIN)  // must not begin with SP or NUL
...
F1(jtcpufeature){F12IP;
 ...
 if (!strcasecmp(CAV(w),"CPU")) {
  ...
  if (sysctlbyname("hw.cachelinesize", &line_size, &size, NULL, 0)) R num(0);
  R sc(line_size);
#elif defined(_WIN32)
  size_t line_size = 0;
  DWORD buffer_size = 0;
  ...
  if (!GetLogicalProcessorInformation(0, &buffer_size)) R num(0);
  buffer = (SYSTEM_LOGICAL_PROCESSOR_INFORMATION *)malloc(buffer_size);
  if (!GetLogicalProcessorInformation(&buffer[0], &buffer_size)) {free(buffer); R num(0);};
 ...
 else if(!strcasecmp(CAV(w),"ASIMD"   )) R num(!!(getCpuFeatures()&ARM_HWCAP_ASIMD ));
 else if(!strcasecmp(CAV(w),"EVTSTRM" )) R num(!!(getCpuFeatures()&ARM_HWCAP_EVTSTRM ));
 else if(!strcasecmp(CAV(w),"AES"     )) R num(!!(getCpuFeatures()&ARM_HWCAP_AES ));
 else if(!strcasecmp(CAV(w),"PMULL"   )) R num(!!(getCpuFeatures()&ARM_HWCAP_PMULL ));
 else if(!strcasecmp(CAV(w),"SHA1"    )) R num(!!(getCpuFeatures()&ARM_HWCAP_SHA1 ));
 else if(!strcasecmp(CAV(w),"SHA2"    )) R num(!!(getCpuFeatures()&ARM_HWCAP_SHA2 ));
 else if(!strcasecmp(CAV(w),"CRC32"   )) R num(!!(getCpuFeatures()&ARM_HWCAP_CRC32 ));
 else if(!strcasecmp(CAV(w),"ATOMICS" )) R num(!!(getCpuFeatures()&ARM_HWCAP_ATOMICS ));
 else if(!strcasecmp(CAV(w),"FPHP"    )) R num(!!(getCpuFeatures()&ARM_HWCAP_FPHP ));
 else if(!strcasecmp(CAV(w),"ASIMDHP" )) R num(!!(getCpuFeatures()&ARM_HWCAP_ASIMDHP ));
 else if(!strcasecmp(CAV(w),"CPUID"   )) R num(!!(getCpuFeatures()&ARM_HWCAP_CPUID ));
 else if(!strcasecmp(CAV(w),"ASIMDRDM")) R num(!!(getCpuFeatures()&ARM_HWCAP_ASIMDRDM ));
 else if(!strcasecmp(CAV(w),"JSCVT"   )) R num(!!(getCpuFeatures()&ARM_HWCAP_JSCVT ));
 else if(!strcasecmp(CAV(w),"FCMA"    )) R num(!!(getCpuFeatures()&ARM_HWCAP_FCMA ));
 else if(!strcasecmp(CAV(w),"LRCPC"   )) R num(!!(getCpuFeatures()&ARM_HWCAP_LRCPC ));
 else if(!strcasecmp(CAV(w),"DCPOP"   )) R num(!!(getCpuFeatures()&ARM_HWCAP_DCPOP ));
 else if(!strcasecmp(CAV(w),"SHA3"    )) R num(!!(getCpuFeatures()&ARM_HWCAP_SHA3 ));
 else if(!strcasecmp(CAV(w),"SM3"     )) R num(!!(getCpuFeatures()&ARM_HWCAP_SM3 ));
 else if(!strcasecmp(CAV(w),"SM4"     )) R num(!!(getCpuFeatures()&ARM_HWCAP_SM4 ));
 else if(!strcasecmp(CAV(w),"ASIMDDP" )) R num(!!(getCpuFeatures()&ARM_HWCAP_ASIMDDP ));
 else if(!strcasecmp(CAV(w),"SHA512"  )) R num(!!(getCpuFeatures()&ARM_HWCAP_SHA512 ));
 else if(!strcasecmp(CAV(w),"SVE"     )) R num(!!(getCpuFeatures()&ARM_HWCAP_SVE ));
 else if(!strcasecmp(CAV(w),"ASIMDFHM")) R num(!!(getCpuFeatures()&ARM_HWCAP_ASIMDFHM ));
 else if(!strcasecmp(CAV(w),"DIT"     )) R num(!!(getCpuFeatures()&ARM_HWCAP_DIT ));
 else if(!strcasecmp(CAV(w),"USCAT"   )) R num(!!(getCpuFeatures()&ARM_HWCAP_USCAT ));
 else if(!strcasecmp(CAV(w),"ILRCPC"  )) R num(!!(getCpuFeatures()&ARM_HWCAP_ILRCPC ));
 else if(!strcasecmp(CAV(w),"FLAGM"   )) R num(!!(getCpuFeatures()&ARM_HWCAP_FLAGM ));
 else if(!strcasecmp(CAV(w),"SSBS"    )) R num(!!(getCpuFeatures()&ARM_HWCAP_SSBS ));
 else if(!strcasecmp(CAV(w),"SB"      )) R num(!!(getCpuFeatures()&ARM_HWCAP_SB ));
 else if(!strcasecmp(CAV(w),"PACA"    )) R num(!!(getCpuFeatures()&ARM_HWCAP_PACA ));
 else if(!strcasecmp(CAV(w),"PACG"    )) R num(!!(getCpuFeatures()&ARM_HWCAP_PACG ));
 else if(!strcasecmp(CAV(w),"DCPODP"  )) R num(!!(getCpuFeatures2()&ARM_HWCAP2_DCPODP ));
 else if(!strcasecmp(CAV(w),"SVE2"    )) R num(!!(getCpuFeatures2()&ARM_HWCAP2_SVE2 ));
 else if(!strcasecmp(CAV(w),"SVEAES"  )) R num(!!(getCpuFeatures2()&ARM_HWCAP2_SVEAES ));
 else if(!strcasecmp(CAV(w),"SVEPMULL" )) R num(!!(getCpuFeatures2()&ARM_HWCAP2_SVEPMULL ));
 else if(!strcasecmp(CAV(w),"SVEBITPERM" )) R num(!!(getCpuFeatures2()&ARM_HWCAP2_SVEBITPERM ));
 else if(!strcasecmp(CAV(w),"SVESHA3" )) R num(!!(getCpuFeatures2()&ARM_HWCAP2_SVESHA3 ));
 else if(!strcasecmp(CAV(w),"SVESM4"  )) R num(!!(getCpuFeatures2()&ARM_HWCAP2_SVESM4 ));
 else if(!strcasecmp(CAV(w),"FLAGM2"  )) R num(!!(getCpuFeatures2()&ARM_HWCAP2_FLAGM2 ));
 else if(!strcasecmp(CAV(w),"FRINT"   )) R num(!!(getCpuFeatures2()&ARM_HWCAP2_FRINT ));
 else if(!strcasecmp(CAV(w),"SVEI8MM" )) R num(!!(getCpuFeatures2()&ARM_HWCAP2_SVEI8MM ));
 else if(!strcasecmp(CAV(w),"SVEF32MM" )) R num(!!(getCpuFeatures2()&ARM_HWCAP2_SVEF32MM ));
 else if(!strcasecmp(CAV(w),"SVEF64MM" )) R num(!!(getCpuFeatures2()&ARM_HWCAP2_SVEF64MM ));
 else if(!strcasecmp(CAV(w),"SVEBF16" )) R num(!!(getCpuFeatures2()&ARM_HWCAP2_SVEBF16 ));
 else if(!strcasecmp(CAV(w),"I8MM"    )) R num(!!(getCpuFeatures2()&ARM_HWCAP2_I8MM ));
 else if(!strcasecmp(CAV(w),"BF16"    )) R num(!!(getCpuFeatures2()&ARM_HWCAP2_BF16 ));
 else if(!strcasecmp(CAV(w),"DGH"     )) R num(!!(getCpuFeatures2()&ARM_HWCAP2_DGH ));
 else if(!strcasecmp(CAV(w),"RNG"     )) R num(!!(getCpuFeatures2()&ARM_HWCAP2_RNG ));
 else if(!strcasecmp(CAV(w),"BTI"     )) R num(!!(getCpuFeatures2()&ARM_HWCAP2_BTI ));
 else if(!strcasecmp(CAV(w),"MTE"     )) R num(!!(getCpuFeatures2()&ARM_HWCAP2_MTE ));
 else if(!strcasecmp(CAV(w),"ECV"     )) R num(!!(getCpuFeatures2()&ARM_HWCAP2_ECV ));
 else if(!strcasecmp(CAV(w),"AFP"     )) R num(!!(getCpuFeatures2()&ARM_HWCAP2_AFP ));
 else if(!strcasecmp(CAV(w),"RPRES"   )) R num(!!(getCpuFeatures2()&ARM_HWCAP2_RPRES ));
 else if(!strcasecmp(CAV(w),"MTE3"    )) R num(!!(getCpuFeatures2()&ARM_HWCAP2_MTE3 ));
 else if(!strcasecmp(CAV(w),"SME"     )) R num(!!(getCpuFeatures2()&ARM_HWCAP2_SME ));
 else if(!strcasecmp(CAV(w),"SME_I16I64" )) R num(!!(getCpuFeatures2()&ARM_HWCAP2_SME_I16I64 ));
 else if(!strcasecmp(CAV(w),"SME_F64F64" )) R num(!!(getCpuFeatures2()&ARM_HWCAP2_SME_F64F64 ));
 else if(!strcasecmp(CAV(w),"SME_I8I32" )) R num(!!(getCpuFeatures2()&ARM_HWCAP2_SME_I8I32 ));
 else if(!strcasecmp(CAV(w),"SME_F16F32" )) R num(!!(getCpuFeatures2()&ARM_HWCAP2_SME_F16F32 ));
 else if(!strcasecmp(CAV(w),"SME_B16F32" )) R num(!!(getCpuFeatures2()&ARM_HWCAP2_SME_B16F32 ));
 else if(!strcasecmp(CAV(w),"SME_F32F32" )) R num(!!(getCpuFeatures2()&ARM_HWCAP2_SME_F32F32 ));
 else if(!strcasecmp(CAV(w),"SME_FA64" )) R num(!!(getCpuFeatures2()&ARM_HWCAP2_SME_FA64 ));
 else if(!strcasecmp(CAV(w),"WFXT"    )) R num(!!(getCpuFeatures2()&ARM_HWCAP2_WFXT ));
#if defined(_WIN64)||defined(__LP64__)
 else if(!strcasecmp(CAV(w),"EBF16"   )) R num(!!(getCpuFeatures2()&ARM_HWCAP2_EBF16 ));
 else if(!strcasecmp(CAV(w),"SVE_EBF16" )) R num(!!(getCpuFeatures2()&ARM_HWCAP2_SVE_EBF16 ));
#endif
 else if(!strcasecmp(CAV(w),"FMA"     )) R num(1);
 else R num(0);
#elif defined(__x86_64__)||defined(__i386__)||defined(_M_X64)||defined(_M_IX86)
 if     (!strcasecmp(CAV(w),"SSSE3"   )) R num(!!(getCpuFeatures()&CPU_X86_FEATURE_SSSE3 ));
 else if(!strcasecmp(CAV(w),"POPCNT"  )) R num(!!(getCpuFeatures()&CPU_X86_FEATURE_POPCNT ));
 else if(!strcasecmp(CAV(w),"MOVBE"   )) R num(!!(getCpuFeatures()&CPU_X86_FEATURE_MOVBE ));
 else if(!strcasecmp(CAV(w),"SSE4_1"  )) R num(!!(getCpuFeatures()&CPU_X86_FEATURE_SSE4_1 ));
 else if(!strcasecmp(CAV(w),"SSE4_2"  )) R num(!!(getCpuFeatures()&CPU_X86_FEATURE_SSE4_2 ));
 else if(!strcasecmp(CAV(w),"AES_NI"  )) R num(!!(getCpuFeatures()&CPU_X86_FEATURE_AES_NI ));
 else if(!strcasecmp(CAV(w),"AVX"     )) R num(!!(getCpuFeatures()&CPU_X86_FEATURE_AVX ));
 else if(!strcasecmp(CAV(w),"RDRAND"  )) R num(!!(getCpuFeatures()&CPU_X86_FEATURE_RDRAND ));
 else if(!strcasecmp(CAV(w),"AVX2"    )) R num(!!(getCpuFeatures()&CPU_X86_FEATURE_AVX2 ));
 else if(!strcasecmp(CAV(w),"SHA_NI"  )) R num(!!(getCpuFeatures()&CPU_X86_FEATURE_SHA_NI ));
 else if(!strcasecmp(CAV(w),"FMA"     )) R num(!!(getCpuFeatures()&CPU_X86_FEATURE_FMA ));
 else if(!strcasecmp(CAV(w),"RDSEED"  )) R num(!!(getCpuFeatures()&CPU_X86_FEATURE_RDSEED ));
 else if(!strcasecmp(CAV(w),"BMI1"    )) R num(!!(getCpuFeatures()&CPU_X86_FEATURE_BMI1 ));
 else if(!strcasecmp(CAV(w),"BMI2"    )) R num(!!(getCpuFeatures()&CPU_X86_FEATURE_BMI2 ));
 else if(!strcasecmp(CAV(w),"AVX512F" )) R num(!!(getCpuFeatures()&CPU_X86_FEATURE_AVX512F));
 else if(!strcasecmp(CAV(w),"AVX512VL" )) R num(!!(getCpuFeatures()&CPU_X86_FEATURE_AVX512VL));
 else if(!strcasecmp(CAV(w),"AVX512DQ" )) R num(!!(getCpuFeatures()&CPU_X86_FEATURE_AVX512DQ));
 else if(!strcasecmp(CAV(w),"AVX512BW" )) R num(!!(getCpuFeatures()&CPU_X86_FEATURE_AVX512BW));
 else if(!strcasecmp(CAV(w),"AVX512IFMA" )) R num(!!(getCpuFeatures()&CPU_X86_FEATURE_AVX512IFMA));
 else if(!strcasecmp(CAV(w),"AVX512VBMI" )) R num(!!(getCpuFeatures()&CPU_X86_FEATURE_AVX512VBMI));
 else if(!strcasecmp(CAV(w),"AVX512VBMI2")) R num(!!(getCpuFeatures()&CPU_X86_FEATURE_AVX512VBMI2));
 else if(!strcasecmp(CAV(w),"RING3MWAIT" )) R num(!!(getCpuFeatures2()&CPU_X86_FEATURE2_RING3MWAIT));
 else if(!strcasecmp(CAV(w),"FSGSBASE" )) R num(!!(getCpuFeatures2()&CPU_X86_FEATURE2_FSGSBASE));
 else R num(0);
#else
 R num(0);
#endif
