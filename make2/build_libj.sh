...
case $jplatform64 in
 ...
 linux/j32*) # linux x86
  ...
  LDFLAGS=" -shared -Wl,-soname,libj.so -m32 -lm -ldl $LDOPENMP32 $LDTHREAD -Wa,--noexecstack "
  OBJS_AESNI=" aes-ni.o "
 ...
 linux/j64avx512*) # linux intel 64bit avx512
  ...
  LDFLAGS=" -shared -Wl,-soname,libj.so -lm -ldl $LDOPENMP $LDTHREAD -Wa,--noexecstack "
