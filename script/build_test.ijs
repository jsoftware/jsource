...
manage building/testing J releases/betas from J
   ...
   build_for'9.8.1'        NB/set build globals and jversion.h
   build_for'9.8.0-beta11'
...
can run in jhs
   ...
   load'git/jsource/test/tsu.ijs' NB. later 9.8 required for load to work
   crashrun ddall
