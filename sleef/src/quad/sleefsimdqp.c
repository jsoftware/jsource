...
#ifdef DORENAME
#include "../arch/qrenamepurec_scalar.h"
#endif
#endif
...
#include "../arch/helperpurec_scalar.h"
#ifdef DORENAME
#include "../arch/qrenamepurecfma_scalar.h"
#endif
