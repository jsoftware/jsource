...
A=. 3#<90000 17$x
B=. 3#<255{."1[ 90000 111$x
C=. 3#<_255{."1[ 90000 111$x
A1=. 3#<u: 90000 17$x
B1=. 3#<255{."1[ u: 90000 111$x
C1=. 3#<_255{."1[ u: 90000 111$x
A2=. 3#<10&u: 90000 17$x
B2=. 3#<255{."1[ 10&u: 90000 111$x
C2=. 3#<_255{."1[ 10&u: 90000 111$x
...
echo^:ECHOFILENAME (6!:2) 'PA=. case1&.> A'
echo^:ECHOFILENAME (6!:2) 'QA=. case2&.> A'
assert. (PA-:QA)
echo^:ECHOFILENAME 'long literal',fn
echo^:ECHOFILENAME (6!:2) 'PB=. case1&.> B'
echo^:ECHOFILENAME (6!:2) 'QB=. case2&.> B'
echo^:ECHOFILENAME (6!:2) 'PC=. case1&.> C'
echo^:ECHOFILENAME (6!:2) 'QC=. case2&.> C'
assert. (PB-:QB)
assert. (PC-:QC)
echo^:ECHOFILENAME 'short literal2',fn
echo^:ECHOFILENAME (6!:2) 'PA1=. case1&.> A1'
echo^:ECHOFILENAME (6!:2) 'QA1=. case2&.> A1'
assert. (PA1-:QA1)
echo^:ECHOFILENAME 'long literal2',fn
echo^:ECHOFILENAME (6!:2) 'PB1=. case1&.> B1'
echo^:ECHOFILENAME (6!:2) 'QB1=. case2&.> B1'
echo^:ECHOFILENAME (6!:2) 'PC1=. case1&.> C1'
echo^:ECHOFILENAME (6!:2) 'QC1=. case2&.> C1'
assert. (PB1-:QB1)
assert. (PC1-:QC1)
echo^:ECHOFILENAME 'short literal4',fn
echo^:ECHOFILENAME (6!:2) 'PA2=. case1&.> A2'
echo^:ECHOFILENAME (6!:2) 'QA2=. case2&.> A2'
assert. (PA2-:QA2)
echo^:ECHOFILENAME 'long literal4',fn
echo^:ECHOFILENAME (6!:2) 'PB2=. case1&.> B2'
echo^:ECHOFILENAME (6!:2) 'QB2=. case2&.> B2'
echo^:ECHOFILENAME (6!:2) 'PC2=. case1&.> C2'
echo^:ECHOFILENAME (6!:2) 'QC2=. case2&.> C2'
assert. (PB2-:QB2)
assert. (PC2-:QC2)
''
)
...
4!:55 ;:'Dlb dlb1 dlb2 Dtb dtb1 dtb2 Dltb dltb1 dltb2 S1 S2 S3 test1'
