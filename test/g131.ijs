...
(1e_8 > >./ | , b-minv a) *. 1e_8>>./|,(id a)-a X b=:%.a=:_50000+?10 10$10000
(1e_8 > >./ | , b-minv a) *. 1e_8>>./|,(id a)-a X b=:%.a=:0.01*_4000+?7 7$10000
(1e_8 > >./ | , b-minv a) *. 1e_8>>./|,(id a)-a X b=:%.a=:0.01*_4000+?35 35$10000
(1e_8 > >./ | , b-minv a) *. 1e_8>>./|,(id a)-a X b=:%.a=:0.01*_4000+?71 71$10000
(1e_8 > >./ | , b-minv a) *. 1e_8>>./|,(id a)-a X b=:%.a=:0.01*_4000+?237 237$10000
(b-:minv a) *. 1e_8>>./|,(id a)-a X b=:%.a=:j./?2 8 8$1300
test =: 3 : '(1e_7 > >./ | , b-minv y) *. 1e_8>>./|,(id y)-y X b=:%.a=:y'
