...
echo (6!:2) 'c=: %. a' [ a=: 0.0231*_4000+?(QKTEST{::2000 2000;500 500)$12200
echo e=. >./|,(id a)-a X c
assert. 1e_8>e
echo (6!:2) 'c=: %. b' [ b=: j./0.0231*_4000+?(2, (QKTEST{::2000 2000;500 500))$12200
echo e=. >./|,(id b)-b X c
assert. 1e_8>e
''
}}^:(9!:56 'cblas')''
...
{{
echo (6!:2) 'c=: %. a' [ a=: 0.0231*_4000+?(QKTEST{::2000 1500;500 300)$12200
echo e=. >./|,a - (a X c) X a
assert. 1e_8>e
echo (6!:2) 'c=: %. b' [ b=: j./0.0231*_4000+?(2, (QKTEST{::2000 1500;500 300))$12200
echo e=. >./|,b - (b X c) X b
assert. 1e_8>e
''
}}''
