...
'index error' -: 13!:13 etx 8 9 10 11  NB. invalid column
...
b_loc_ =: {{ c y }}
c_z_ =: d_loc2_
d_loc2_ =: {{ 13!:13 ] 0 1 9 10 }}
(];._2 (0 : 0)) -: ": h }. foo  =: a_loc_ ''
+-------+-+----+-------------------------+
|d_loc2_|0|loc2|+-+-----+---------------+|
|       | |    ||0|1 1 0|13!:13]0 1 9 10||
|       | |    |+-+-----+---------------+|
+-------+-+----+-------------------------+
|c      |0|loc |                         |
+-------+-+----+-------------------------+
...
(271828) 18!:55 ;:'loc1 loc2 loc3'

'xxx' 13!:8 :: 1: (2)  NB. indic error
(('|xxx' -: 4&{.) , ('|   ''xxx''    13!:8 ::1:(2)',LF) -: LF dropafter LF&takeafter) xx=: 13!:12 ''
2 = 13!:11''
...
0 = ([ 13!:_9@1:) 13!:_9 '' [ 13!:_10 'i. 0 0' [ 13!:_9 (0)   NB. verify return to nonrecur level
(>:1) -: ([ 13!:_9@1:) 13!:_10 '($0) a: 13!:8 >: 13!:_9$0' [ 13!:_9 (0)  NB. route state through error code 
