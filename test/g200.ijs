...
f"0 (i:2)+<.%:<:2^53
f"0 i. QKTEST{1000 100
f"0 (-i. QKTEST{1000 100) + <.%:<:2^IF64{31 63
...
f"0 (i. 3)+<.%:<:2^IF64{31 63
f"0 (i:2)+<.%:<:2^53
f"0 (2) + i. QKTEST{1000 100
f"0 (-i. QKTEST{1000 100) + <.%:<:2^IF64{31 63
f QKTEST{7700892415753674751x 3674751x
1
)

0!:_1`1:@.(16b40 *@:(17 b.) 9!:56'memaudit') '$'   NB. skip if memaudit sparse
