...
NB. Gerund form inplaceable
(140000 * SZI) > 7!:2 '+:^:(0:`>:) i. 100000'
(140000 * SZI) > 7!:2 '+:^:(1:`>:) i. 100000'
a =: i. 100000
(140000 * SZI) > 7!:2 '+:^:(0:`>:) a'
a -: i. 100000
(140000 * SZI) > 7!:2 '+:^:(1:`>:) a'
...
(+:^:(0:`>:) a) -: (>: a)
(+:^:(1:`>:) a) -: (+: >: a)
((140000*SZI)&>) 7!:2 'a +^:(0:`(>:@])) i. 100000'
a -: i. 100000
((140000*SZI)&>) 7!:2 'a +^:(1:`(>:@])) i. 100000'
a -: i. 100000
(140000 * SZI) > 7!:2 '>:^:2 i. 100000'
(140000 * SZI) > 7!:2 '1 +^:1: i. 100000'
(140000 * SZI) > 7!:2 '1 +^:_1: i. 100000'
(140000 * SZI) > 7!:2 '1 +^:_1 i. 100000'
