...
(-"+/ .* eqf -/ .*) m=: ?5 5$2
(-"+/ .* eqf -/ .*) m=: ?(QKTEST{::7 7;6 6)$2

(-"+/ .* eqf -/ .*) m=: _100+?5 5$200
(-"+/ .* eqf -/ .*) m=: _100+?(QKTEST{::7 7;6 6)$200

(-"+/ .* eqf -/ .*) m=: 0.1*_100+?5 5$2000
(-"+/ .* eqf -/ .*) m=: 0.1*_100+?(QKTEST{::7 7;6 6)$2000

(-"+/ .* eqf -/ .*) m=: j./0.1*_100+?2 5 5$2000
(-"+/ .* eqf -/ .*) m=: j./0.1*_100+?(QKTEST{::2 7 7;2 6 6)$2000

(-"+/ .* eqf -/ .*) m=: _100+?5 5$200x
(-"+/ .* eqf -/ .*) m=: _100+?(QKTEST{::7 7;6 6)$200x

(-"+/ .* eqf -/ .*) m=: %/1+?2 4 4$200x
(-"+/ .* eqf -/ .*) m=: %/1+?(QKTEST{::2 6 6;2 5 5)$200x
