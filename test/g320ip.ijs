...
NB. hook/@:/&:
assert. ((<1),<(<I),(<P;1),(<3),<P;0) -: 1 (9!:_3)@:(9!:_3) 0
assert. ((<01),<(<I),(<P;1),(<01),<P;0) -: (1 (9!:_3)@:(9!:_3) ]) 0
assert. ((<1),<(<I),(<P;0),(<2),<P;1) -: (1 (9!:_3)@:(9!:_3)~ ]) 0
...
NB. Dyad 15!:15 ---------------------------------------------------
(15!:19@:(15!:15) = 15!:19) >: i. 1000  NB. no copy
(15!:19@:(''&(15!:15)) ~: 15!:19) >: i. 1000   NB. force copy
{{
  a =. i. 1000
  b =: i. 2000
  assert. (15!:19@:(1&(15!:15)) = 15!:19) a NB. no copy
  assert. (15!:19@:(2&(15!:15)) = 15!:19) b NB. no copy
  c =. a
  assert. (15!:19@:(1&(15!:15)) ~: 15!:19) a NB. aliased, copy
  c =. b
  assert. (15!:19@:(2&(15!:15)) ~: 15!:19) b NB. aliased, copy
  1
}} ''
