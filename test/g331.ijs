...
(2 2$"1 ] 2 3 4 5*"1 ] _1^#:i.16) f"2 x=: sdot{~?10 11$#sdot
...
1  test t=: (2 3$s:@<"0 'abcdef') ( 0,(<&998 # ])+/\2+?40$50)}sdot{~?1000 2 3$#sdot
_1 test t
2  test t=: (2 3$s:@<"0 'abcdef') (_1,(<&998 # ])+/\2+?40$50)}sdot{~?1000 2 3$#sdot
_2 test t
...
4!:55 ;:'a adot1 adot2 sdot b c f f1 f2 f3 f4 f5'
