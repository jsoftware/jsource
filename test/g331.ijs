...
(3 $ ,: i. 4 5) -: (3 2 0$0)  ]"];.0 etx memu i.4 5  NB. used to crash if not virtual y
...
NB. Verify < and <"n produces virtual when WILLOPEN
a =: 10 1e5 $ ' '
10000 > 7!:2 '#@>@:(<"1) a'
10000 >  7!:2 '(#@>@<)"1 r'  NB. Also verify < does not realize if WILLOPEN
...
1  test t=: 'a' ( 0,(<&(QKTEST{3000 300) # ]) +/\2+?40$(QKTEST{1500 150))}(QKTEST{3000 300)$'xyz'
_1 test t
2  test t=: 'a' (_1,(<&(QKTEST{3000 300) # ]) +/\2+?40$(QKTEST{1500 150))}(QKTEST{3000 300)$'xyz'
_2 test t

1  test t=: (u:'a') ( 0,(<&(QKTEST{3000 300) # ]) +/\2+?40$(QKTEST{1500 150))}(QKTEST{3000 300)$u:'xyz'
_1 test t
2  test t=: (u:'a') (_1,(<&(QKTEST{3000 300) # ]) +/\2+?40$(QKTEST{1500 150))}(QKTEST{3000 300)$u:'xyz'
_2 test t

1  test t=: (10&u:'a') ( 0,(<&(QKTEST{3000 300) # ]) +/\2+?40$(QKTEST{1500 150))}(QKTEST{3000 300)$10&u:'xyz'
_1 test t
2  test t=: (10&u:'a') (_1,(<&(QKTEST{3000 300) # ]) +/\2+?40$(QKTEST{1500 150))}(QKTEST{3000 300)$10&u:'xyz'
_2 test t

1  test t=: (s:@<"0 'a') ( 0,(<&(QKTEST{3000 300) # ]) +/\2+?40$(QKTEST{1500 150))}(QKTEST{3000 300)$s:@<"0 'xyz'
_1 test t
2  test t=: (s:@<"0 'a') (_1,(<&(QKTEST{3000 300) # ]) +/\2+?40$(QKTEST{1500 150))}(QKTEST{3000 300)$s:@<"0 'xyz'
_2 test t
...
1  test t=: 11 ( 0,(<&(QKTEST{3000 300) # ]) +/\2+?40$(QKTEST{1500 150))}?(QKTEST{3000 300)$10
_1 test t
2  test t=: 11 (_1,(<&(QKTEST{3000 300) # ]) +/\2+?40$(QKTEST{1500 150))}?(QKTEST{3000 300)$10
_2 test t
...
*./ (f2 -: <;._3)@i. 5 5  #:i.25
empty (f2)@i. 3 3 3#:i.27
empty (<;._3)@i. 3 3 3#:i.27
empty (f2 -: <;._3)@i. 3 3 3#:i.27
empty *./ (f2 -: <;._3)@i. 3 3 3#:i.27
*./ (f2 -: <;._3)@i. 3 3 3#:i.27
...
(x=: ?(QKTEST{::30 40 2 2;3 4 2 2)$9) (f1 -: <;. 3)"2 i. 11 13
(x=: ?(QKTEST{::30 40 2 2;3 4 2 2)$9) (f2 -: <;._3)"2 i. 11 13
...
(x=: ?(0 0 0 _1&+^:QKTEST 3 4 2 5)$9) (<cut3 -: <;. 3)"2 _ i. (4&{.)^:QKTEST 11 13 15 12 15
(x=: ?(0 0 0 _1&+^:QKTEST 3 4 2 5)$9) (<cutm3 -: <;. _3)"2 _ i. (4&{.)^:QKTEST 11 13 15 12 15
...
(x=: ?(QKTEST{::30 40 2 2;3 4 2 2)$9) (<@(]"]);.3 -: <;. 3)"2 i. 11 13
(x=: ?(QKTEST{::30 40 2 2;3 4 2 2)$9) (<@:(]"]);.3 -: <;. 3)"2 i. 11 13
(x=: ?(QKTEST{::30 40 2 2;3 4 2 2)$9) (([:<]);.3 -: <;. 3)"2 i. 11 13
(x=: ?(QKTEST{::30 40 2 2;3 4 2 2)$9) (<@(]"1);.3 -: (<@(]"]))"1;. 3)"2 i. 11 13
NB. Verify that it is detected
THRESHOLD +. (2 (6!:2) '(1 1,:1 1) <"<;._3 a') > 1.1 * (2 (6!:2) '(1 1,:1 1) <@(]"]);._3 a') [ a =: i. QKTEST{::100 100;10 10
THRESHOLD +. (2 (6!:2) '(1 1,:1 1) <"<;._3 a') > 1.1 * (2 (6!:2) '(1 1,:1 1) <@:(]"]);._3 a') [ a =: i. QKTEST{::100 100;10 10
THRESHOLD +. (2 (6!:2) '(1 1,:1 1) <"<;._3 a') > 1.1 * (2 (6!:2) '(1 1,:1 1) ([:<]);._3 a') [ a =: i. QKTEST{::100 100;10 10
...
(((i. 50+?20)(,"0 1)2 1) (<@(?@$)"1) (QKTEST{::5000 1000;50 10)) f1 <i. ((QKTEST{10000 100)+?20)
(((i. 50+?20)(,"0 1)2 1) (<@(?@$)"1) (QKTEST{::5000 1000;50 10)) f1 <o. i. ((QKTEST{10000 100)+?20)
(((i. 50+?20)(,"0 1)2 1) (<@(?@$)"1) (QKTEST{::5000 1000;50 10)) f1 <r. i. ((QKTEST{10000 100)+?20)
(((i. 50+?20)(,"0 1)2 1) (<@(?@$)"1) (QKTEST{::5000 1000;50 10)) f1 <x: i. ((QKTEST{10000 100)+?20)
(((i. 50+?20)(,"0 1)2 1) (<@(?@$)"1) (QKTEST{::5000 1000;50 10)) f1 <0 = 2 | i. ((QKTEST{10000 100)+?20)
