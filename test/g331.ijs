...
a =: <@:i."0 (10000) ?@$ 5
(#@,@> -: #"#@,@>) a
(#@(64#16b43{a.)@> -: #"#@(64#16b43{a.)@>) 'abc';(o. i. 10);'';5   NB. 16b43 is CDOLLAR - the noun has the ID of the verb $
NB. sometimes fails 0.2 > %/ 1000&(6!:2)@> '#@,@> a' ; '#"#@,@> a' [ a =: 1024$a:
0.35 > %/ 1000&(6!:2)@> '#@,@> a' ; '#"#@,@> a' [ a =: 1024$a:
NB.  #@:,@> y -----------------------------------------------------------
...
1 [ (f2)@i. 3 3 3#:i.27
1 [ (<;._3)@i. 3 3 3#:i.27
1 [ (f2@i. 3 3 3#:i.27) -: (<;._3)@i. 3 3 3#:i.27
*./ (f2 -: <;._3)@i. 3 3 3#:i.27
