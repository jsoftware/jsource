...
test=: 1 : 0
 ...
 neareq =.  [: *./ (1e_12 >. 1e_13 * >.&:|) > |@:-
 if. *./0=#;.1~x do.
  assert. (0#y)                    -: x ([: ; <@(u f./\ );. 1) etx1 y
  assert. (0#y)                    -: x ([: ; <@(u f./\.);. 1) etx1 y
 else.
  assert. (; x <@(u f./\ );. 1 etx1 y) neareq x ([: ; <@(u f./\ );. 1) etx1 y
  assert. (; x <@(u f./\.);. 1 etx1 y) neareq x ([: ; <@(u f./\.);. 1) etx1 y
 end.
 if. *./0=#;.2~x do.
  assert. (0#y)                    -: x ([: ; <@(u f./\ );. 2) etx1 y
  assert. (0#y)                    -: x ([: ; <@(u f./\.);. 2) etx1 y
 else.
  assert. (; x <@(u f./\ );. 2 etx1 y) neareq x ([: ; <@(u f./\ );. 2) etx1 y
  assert. (; x <@(u f./\.);. 2 etx1 y) neareq x ([: ; <@(u f./\.);. 2) etx1 y
 end.
 if. *./0=#;._1~x do.
  assert. (0#y)                    -: x ([: ; <@(u f./\ );._1) etx1 y
  assert. (0#y)                    -: x ([: ; <@(u f./\.);._1) etx1 y
 else.
  assert. (; x <@(u f./\ );._1 etx1 y) neareq x ([: ; <@(u f./\ );._1) etx1 y
  assert. (; x <@(u f./\.);._1 etx1 y) neareq x ([: ; <@(u f./\.);._1) etx1 y
 end.
 if. *./0=#;._2~x do.
  assert. (0#y)                    -: x ([: ; <@(u f./\ );._2) etx1 y
  assert. (0#y)                    -: x ([: ; <@(u f./\.);._2) etx1 y
 else.
  assert. (; x <@(u f./\ );._2 etx1 y) neareq x ([: ; <@(u f./\ );._2) etx1 y
  assert. (; x <@(u f./\.);._2 etx1 y) neareq x ([: ; <@(u f./\.);._2) etx1 y
 end.
 1
)
