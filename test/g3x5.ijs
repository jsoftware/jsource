...
(11 fc x) -: 11 fc 1=    x=:(o.0)+?10$2
(11 fc x) -: 11 fc <.    x=:(o.0)+_50+?10$100
(11 fc x) -: 11 fc (j.0)+x=:(o.0)+_50+?10$100
...
'domain error' -: _11 fc etx 0 1 0 0
'domain error' -: _11 fc etx 1 2 3.4 5
'domain error' -: _11 fc etx 1 2 3j4 5
'domain error' -: _11 fc etx 1;2 3 4;5 6

'rank error'   -:  11 fc etx i.1 4
...
'domain error' -: _11 fc etx u:'ab'
'domain error' -: _11 fc etx u:'abcdef'
'domain error' -: _2 fc etx u:'ab'
'domain error' -: _2 fc etx u:'abcdef'
'domain error' -: _1 fc etx u:'a'
'domain error' -: _1 fc etx u:'abc'
'domain error' -: _11 fc etx 10&u:'ab'
'domain error' -: _11 fc etx 10&u:'abcdef'
