...
NB. Using v
315 339 381 441 519 -: (6;100 101 102) ((, 0&{::) ; (+ 1&{::)) F:. (+/@:;) i. 5 3
387 447 489 513 519 -: (6;100 101 102) ((, 0&{::) ; (+ 1&{::)) F:: (+/@:;) i. 5 3
NB. early termination
9 21 42 -: (6;100 101 102) ((, 0&{::) ; (+ 1&{::)) F:. (+/@:(0&{::) [ _2 Z: 9 e. 0&{::) i. 5 3
9 21 72 111 -: (6;100 101 102) ((, 0&{::) ; (+ 1&{::)) F:. (+/@:(0&{::) [ _1 Z: 42 = [: +/ 0&{::) i. 5 3
9 21 72 111 -: (6;100 101 102) ((, 0&{::) ; (+ 1&{::)) F:. (+/@:(0&{::) [ 0 Z: 42 = [: +/ 0&{::) i. 5 3
9 21 42 -: (6;100 101 102) ((, 0&{::) ; (+ 1&{::)) F:. (+/@:(0&{::) [ 1 Z: 42 = [: +/ 0&{::) i. 5 3
NB. early termination in u
9 21 42 -: (6;100 101 102) ([ _2 Z: 9 e. 0&{::)@:((, 0&{::) ; (+ 1&{::)) F:. (+/@:(0&{::))  i. 5 3
9 21 51 90 -: (6;100 101 102)  ([ _1 Z: 42 = [: +/ 0&{::)@((, 0&{::) ; (+ 1&{::)) F:. (+/@:(0&{::)) i. 5 3
9 21 72 111 -: (6;100 101 102)  ([ 0 Z: 42 = [: +/ 0&{::)@((, 0&{::) ; (+ 1&{::)) F:. (+/@:(0&{::)) i. 5 3
9 21 42 -: (6;100 101 102)  ([ 1 Z: 42 = [: +/ 0&{::)@((, 0&{::) ; (+ 1&{::)) F:. (+/@:(0&{::)) i. 5 3
NB. empty results
'domain error' -: (6;100 101 102) ((, 0&{::) ; (+ 1&{::)) F:. (+/@:(0&{::) [ _2 Z: 6 e. 0&{::) etx i. 5 3
NB. empty arguments
0 -: + F.. ] i. 0
1 -: * F.. ] i. 0
(0$0) -: + F:. ] i. 0
...
NB. F. F:
102 51 154 77 232 116 58 29 88 44 22 11 34 17 52 26 13 40 20 10 5 16 8 4 2 -: (, -:`(1 3&p.)@.(2&|)@{:) F. ([   _2 Z: 1 = {:) 102
51 154 77 232 116 58 29 88 44 22 11 34 17 52 26 13 40 20 10 5 16 8 4 2 -: (, -:`(1 3&p.)@.(2&|)@{:) F: (([   _2 Z: 1 = ])@{:) 102
102 51 154 77 232 116 58 29 88 44 22 11 34 17 52 26 13 40 20 10 5 16 8 4 2 -: (, -:`(1 3&p.)@.(2&|)@{:) F. ([   _2 Z: 1 = {: [ _1 Z: 88 = {:) 102
51 154 77 232 116 58 29 44 22 11 34 17 52 26 13 40 20 10 5 16 8 4 2 -: (, -:`(1 3&p.)@.(2&|)@{:) F: (([   _2 Z: 1 = ] [ _1 Z: 88 = {:)@{:) 102
102 51 154 77 232 116 58 29 88 44 22 11 34 17 52 26 13 40 20 10 5 16 8 4 2 -: ([  0 Z: 88 = {:)@(, -:`(1 3&p.)@.(2&|)@{:) F. ([   _2 Z: 1 = {:) 102
51 154 77 232 116 58 29 44 22 11 34 17 52 26 13 40 20 10 5 16 8 4 2 -: ([  0 Z: 88 = {:)@(, -:`(1 3&p.)@.(2&|)@{:) F: (([   _2 Z: 1 = ])@{:) 102
102 51 154 77 232 116 58 29 -: ([  1 Z: 88 = {:)@(, -:`(1 3&p.)@.(2&|)@{:) F. ([   0 Z: 88 = {:) 102
51 154 77 232 116 58 29 -: ([  1 Z: 88 = {:)@(, -:`(1 3&p.)@.(2&|)@{:) F: (([   0 Z: 88 = ])@{:) 102
NB. empty result
'domain error' -: (, -:`(1 3&p.)@.(2&|)@{:) F: ([   _2 Z: 51 = {:) etx 102
'domain error' -: (, -:`(1 3&p.)@.(2&|)@{:) F. ([   _2 Z: 51 = {:) etx 102
