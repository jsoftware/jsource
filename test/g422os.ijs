...
0.7 > %/ 10000&(6!:2) '5 ({ /:) y' ,: '5 ({ /:"_) y'    NB. 0.64 on vs2019 avx2
0.7 > %/ 10000&(6!:2) '5 ({ /:~) y' ,: '5 ({ /:~"_) y'  NB. 0.53 on raspi32 0.68 on vs2019 avx2
y=: 0.1 * y
0.7 > %/ 10000&(6!:2) '5 ({ /:) y' ,: '5 ({ /:"_) y'    NB. 0.66 on vs2019 avx2
0.75 > %/ 10000&(6!:2) '5 ({ /:~) y' ,: '5 ({ /:~"_) y' NB. 0.71 on vs2019 avx2
