...
cr =: 4 : 0
min =. <./ y , (#~  ~:&_1) 0 { x  NB. Ignore min if -1
max =. >./ y , 1 { x
if. (max-min) >: 2 { x do.
 0 0
else.
...
(imax,imin,imax)&(cr -: 13!:80)\ yy =: (i. 64) , 2000 _2000,_50 + ?~ 100
(imax,imin,imax)&(cr -: 13!:80)\. yy
((imax,imin),"1 0 ] 3990 +i. 20) (cr -: 13!:80)"1 yy
_3000 3000 10000 (cr -: 13!:80) yy
_3000 3000 10000 (cr -: 13!:80) }. yy

(_1,0,imax)&((cr 3&u:) -: 13!:81)\ yy =: 10 u: (i. 64) , 2000 12000, ?~ 100
(_1,0,imax)&((cr 3&u:) -: 13!:81)\. yy
((_1,0),"1 0 ] 3990 +i. 20) ((cr 3&u:) -: 13!:81)"1 yy
_3000 3000 10000 ((cr 3&u:) -: 13!:81) yy
_3000 3000 10000 ((cr 3&u:) -: 13!:81) }. yy

(_1,0,imax)&((cr 3&u:) -: 13!:82)\ yy =: 4 u: (i. 64) , 2000 12000,?~ 100
(_1,0,imax)&((cr 3&u:) -: 13!:82)\. yy
((_1,0),"1 0 ] 3990 +i. 20) ((cr 3&u:) -: 13!:82)"1 yy
