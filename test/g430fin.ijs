1:@:(dbr bind Debug)@:(9!:19)2^_44[(echo^:ECHOFILENAME) './g430fin.ijs'
NB. x +/\ y -------------------------------------------------------------
...
(imax,imin,imax)&(cr -: 13!:80)\ yy =: (i. 64) , 2000 _2000,_500 + ?~ 100
(0,0,imax)&(cr -: 13!:80)\ yy =: (i. 64) , 2000 _2000,_500 + ?~ 100
(imax,imin,imax)&(cr -: 13!:80)\ yy =: (i. 64) , 2000 _2000,5 * _500 + ?~ 100
...
(16bffffffff,0,imax)&((cr 3&u:) -: 13!:81)\ yy =: 10 u: (i. 64) , 2000 12000, ?~ 100
(16bffffffff,0,imax)&((cr 3&u:) -: 13!:81)\. yy
((16bffffffff,0),"1 0 ] 3990 +i. 20) ((cr 3&u:) -: 13!:81)"1 yy
_3000 3000 10000 ((cr 3&u:) -: 13!:81) yy
_3000 3000 10000 ((cr 3&u:) -: 13!:81) }. yy

(16bffffffff,0,imax)&((cr 3&u:) -: 13!:82)\ yy =: 4 u: (i. 64) , 2000 12000,?~ 100
(16bffffffff,0,imax)&((cr 3&u:) -: 13!:82)\. yy
((16bffffffff,0),"1 0 ] 3990 +i. 20) ((cr 3&u:) -: 13!:82)"1 yy
_3000 3000 10000 ((cr 3&u:) -: 13!:82) yy
_3000 3000 10000 ((cr 3&u:) -: 13!:82) }. yy

4!:55 ;:'cr f g mm sum test yy'
