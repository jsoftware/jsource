...
(imax,imin,imax)&(cr -: 13!:_1)\ yy =: (i. 64) , 2000 _2000,_500 + ?~ 1000   NB.  starting min, starting max, max range
(0,0,imax)&(cr -: 13!:_1)\ yy =: (i. 64) , 2000 _2000,_500 + ?~ 1000
(_10000 _10000,imax)&(cr -: 13!:_1)\ yy =: (i. 64) , 2000 _2000,_500 + ?~ 1000
(10000 10000,imax)&(cr -: 13!:_1)\ yy =: (i. 64) , 2000 _2000,_500 + ?~ 1000
(imax,imin,imax)&(cr -: 13!:_1)\ yy =: (i. 64) , 2000 _2000,5 * _500 + ?~ 1000
(imax,imin,imax)&(cr -: 13!:_1)\. yy
(imax,imin,imax)&(cr -: 13!:_1)\ yy =: (i. 64) , 2000 _2000,5 * _5000 + ?~ 1000
(imax,imin,imax)&(cr -: 13!:_1)\. yy
(imax,imin,imax)&(cr -: 13!:_1)\ yy =: (i. 64) , 2000 _2000,5 * 5000 + ?~ 1000
(imax,imin,imax)&(cr -: 13!:_1)\. yy
((imax,imin),"1 0 ] 3990 +i. 20) (cr -: 13!:_1)"1 yy
_3000 3000 10000 (cr -: 13!:_1) yy
_3000 3000 10000 (cr -: 13!:_1) }. yy
...
THRESHOLD +. (10 (6!:2) '(imax,imin,1000) 13!:_1 yy3') > 5 * (10 (6!:2) '(imax,imin,1000) 13!:_1 yy1')
3 : 0 ''
if. -. 'avx2' +./@:E. 9!:14'' do. 1 return. end.
THRESHOLD +. (10 (6!:2) '(imax,imin,1000) 13!:_1 yy3') > 5 * (10 (6!:2) '(imax,imin,1000) 13!:_1 yy2')
)

(16b7fffffff,0,imax)&((cr 3&u:) -: 13!:_2)\ yy =: 10 u: (i. 64) , 2000 12000, ?~ 100
(16b7fffffff,0,imax)&((cr 3&u:) -: 13!:_2)\. yy
((16b7fffffff,0),"1 0 ] 3990 +i. 20) ((cr 3&u:) -: 13!:_2)"1 yy
_3000 3000 10000 ((cr 3&u:) -: 13!:_2) yy
_3000 3000 10000 ((cr 3&u:) -: 13!:_2) }. yy

(16b7fffffff,0,imax)&((cr 3&u:) -: 13!:_3)\ yy =: 4 u: (i. 64) , 2000 12000,?~ 100
(16b7fffffff,0,imax)&((cr 3&u:) -: 13!:_3)\. yy
((16b7fffffff,0),"1 0 ] 3990 +i. 20) ((cr 3&u:) -: 13!:_3)"1 yy
_3000 3000 10000 ((cr 3&u:) -: 13!:_3) yy
_3000 3000 10000 ((cr 3&u:) -: 13!:_3) }. yy
