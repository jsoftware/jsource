...
NB. Zero Frow
M=. |: _4 ]\ _1. _1 1 2   _1 _1 1 1    _1 _1e_3 1e10 1   _1 _1 1.0000000000001 1   NB. 2 non0, 1 0; 2 non0, 2 0; only 1 non0 (c too small); 2 non0, 2 0 (close enough)
Frow=. ''   NB. rows are immaterial
bk =. _1e_13 1e_13 1 1  NB. bk in order
bkg=.\: bk
assert. 2 0 3 0 4 1 -: (128!:9) 0 1 2 3;(,."1 (_2) ]\ 00 0);(0$00);(0$0.0);M;bkg;1e_11 1e_6 1e_11 0 1 1.0 1;bk;Frow;($00);(4 5 6 7)  NB. 2 non0, 1 0
assert. 2 0 3 3 16 1 -: (128!:9) 1 2 3 0;(,."1 (_2) ]\ 00 0);(0$00);(0$0.0);M;bkg;1e_11 1e_6 1e_11 0 1 1.0 1;bk;Frow;($00);(4 5 6 7)  NB. 2 non0, 2 0
assert. 3 0 0 4 16 0 -: (128!:9) 1 2 3 0;(,."1 (_2) ]\ 00 0);(0$00);(0$0.0);M;bkg;1e_11 1e_6 1e_11 0 1 1.0 1;bk;Frow;(,16b000000007);(4 5 6 7)  NB. Pivot excluded
1
}}^:(1 e. 'avx2' E. 9!:14'') 1
