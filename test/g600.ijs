...
a=:1e5 ?@$ 0
(-."+ a) -: -."+"+ a
THRESHOLD +. '-."+ a' (> 0.5&*)&(10&(6!:2)) '-."+"+ a'
0 = {. -."+"+ b. 0
(-."+ a) -: -."+"1 a
THRESHOLD +. '-."+ a' (> 0.5&*)&(10&(6!:2)) '-."+"1 a'
1 = {. -."+"1 b. 0
...
(2 2 2 $ 1 2 3 0 4 5 0 0) -:{{ > y }} "0. "1. ] 2 2 $ 1 2;3;4;5
...
a =: 2 2 2 3 $ (,~ 7 8 0) , (6 # 0) , ,~ i. 6
a -: ("."2.) 2 2 _ ($,) '7 8' , '7 8' , 'i. 2 3' ,: 'i. 2 3'
a -: (2 2 1 $ 0 0 1 1) ({::"2.) 7 8 ; i. 2 3
a =: 1 ,: 4 # 2
b =: (4 4 3 ($,) 6 (#"0) 1 0) ,:~ (4 3 $ 1 1 0) , 3 4 3 $ 0
b -: 1 ($~ {.&2 3)"0"1. a
a =: (,:~ 0 1 (<@,"0/) 2 3) ,: a: ,:~ (0 0 (<@,"0/) 2 3)
a -: ({"2.) 2 2 2 $ (,~ 0 1 ; 2 3) , ,~ 0 ; 2 3
a =: 2 2 2 4 $ (97 101 , 14 # 0) , 2 5 0 0 2 2 0 0 2 2 5 5 0 0 0 0
a -: (2 2 $ _4 4 2 3) (p:"0"1.) 100
a =: 2 2 2 2 $ (1 2 1 2 , 4 # 0) , ,~ 1 0 3 2
a -: |.S:0"1"2. (,:~ 1 ; 2) ,: ,:~ (<0 1) , <<2 3
f =: {{ if. y -: 'ab' do. i. 2 3 4 else. i. 5 end. }}
a =: (,:~ 0 ,~"0 1 i. 2 3 4) ,: 2 2 3 5 $ (,~ i. 5) , 50 # 0
a -: (f"1"2.) 2 2 2 $ 'ababcdcd'
a =: 2 3 $ (< < 1 2) , 5 # (< < 3)
b =: 2 3 3 $ 1 2 0 3 0 0 3 0 0 3 3 3 , 6 # 0
b -: a {"{"1 i. 4  NB. No IRS
