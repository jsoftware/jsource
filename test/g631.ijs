...
a =: i. 3 4
((>: b { a) b} a) -: >:&.(c&(];.0)) a [ b =. 1 [ c =: ,.01 1
((>: b { a) b} a) -: >:&.(c&(];.0)) a [ b =. 1 2 [ c =: ,.1 2
((|.!.0 b { a) b} a) -: |.!.0&.(c&(];.0)) a [ b =. 1 2 [ c =: ,.1 2
((|.!.0 b { a) b} a) -: |.!.0&.(c&(];.0)) a [ b =. 1 2 [ c =: ,.1 3
((|.!.0 b { a) b} a) -: |.!.0&.(c&(];.0)) a [ b =. 1 2 [ c =: ,._1 2
a =: i. 3 1e6
3000 > 7!:2 'a =: >:&.(c&(];.0)) a' [ c =: ,.01 1
3000 > 7!:2 'a =: >:&.(c&(];.0)) a' [ c =: ,.2 1
1 = (0.9 1.1 * 2e6 * SZI) I. 7!:2 'a =: |.!.0&.(c&(];.0)) a' [ c =: ,.1 2
1 = (0.9 1.1 * 4e6 * SZI) I. 7!:2 'a =: |.!.0&.(c&(];.0)) a' [ c =: ,.0 3
'domain error' -: ". etx '|.!.0&.(c&(];.0)) a' [ b =. 1 2 [ c =: ,._1 _2
