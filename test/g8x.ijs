1:@:(dbr bind Debug)@:(9!:19)2^_44[(echo^:ECHOFILENAME) './g8x.ijs'
NB. 8!:n ----------------------------------------------------------------
...
'-9.223372037e18'-: > 'c' fmt _9223372036854775808
...
(<'null') -: 'd<inf>i<null>' fmt __
(<'inf') -: 'd<inf>i<null>' fmt _
(<'null') -: 'd<inf>i<null>' fmt imin
(<'null') -.@-: 'd<inf>i<null>' fmt imin+1
...
4 -: 3!:0 y=:".x=:'2123456789'
('2.123456789e9') -: >'' fmt y

8 -: 3!:0 y=:".x=:'2.123456789e9'
x -: >'' fmt y
...
NB. Denormals
(,:'5.562684646e-309')-: (8!:2) 2 ^ _1024
(,:'1.390671162e-309')-: (8!:2) 2 ^ _1026
(,:'6.3e-322')-: (8!:2) 2 ^ _1067
(,:'-5.562684646e-309')-: (8!:2) -2 ^ _1024
(,:'-1.390671162e-309')-: (8!:2) -2 ^ _1026
(,:'-6.3e-322')-: (8!:2) -2 ^ _1067

' N5.00000  E5.00000' -: (,'p<N>m<S>9.5,p<E>m<W>10.5 ' 8!:2 [5 5)  NB. trailing space allowed
