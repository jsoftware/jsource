...
'open quote' -: ". etx '{{ a. =: }}'  NB. used to crash
'syntax error' -: {{ name =. }} etx 5
'syntax error' -: {{ name =: }} etx a.
...
'3 : ''''' -: 5!:5 <'t' [. t =. {{ }}  NB. These are unexexcutable but they can be displayed
'3 : ''''' -: 5!:5 <'t' [. t =. {{)m }}
'4 : ''''' -: 5!:5 <'t' [. t =. {{)d }}
'1 : ''''' -: 5!:5 <'t' [. (". 't =. {{)a }}')
'2 : ''''' -: 5!:5 <'t' [. (". 't =. {{)c }}')
...
f0 > _5000 + 7!:0''
f3 =: 3 : '(i. 1e6)'
f0 > _5000 + 7!:0''  NB. no pppp
f3 =: 3 : '] ] ] ] ] ] y'
f1 =: 7!:0''
f3 =: 3 : '(] ] ] ] ] ]) y'
f1 < _250 + 7!:0''  NB. pppp
f3 =: 3 : '((i. 1e6))'
f0 < _4000000 + 7!:0''  NB. pppp
f3 =: 3 : '((". ''i. 1e6''))'
f0 > _4000000 + 7!:0''   NB. no pppp
...
f3 =: 3 : '(15!:0 ] ] ] ] ] ] ] ]) ((a.))'
f2 =: 7!:0''
128 > | f2 - f1   NB. no pppp
f3 =: 3 : '((15!:0) ] ] ] ] ] ] ] ]) (a.)'
f2 =: 7!:0''
f1 < _250 + f2   NB. pppp
f3 =: 3 : '(((15!:0) ] ] ] ] ] ] ] ] a.))'
f2 =: 7!:0''
256 > | f2 - f1   NB. a little pppp, but no execution
...
f3 =: 3 : '(3 : (''y'') 3 : (''y'') 3 : (''y'') 3 : (''y'') 3 : (''y'')) y'
f2 =: 7!:0''
128 > | f2 - f1  NB. no pppp on m : n
f3 =: 3 : '((3 : ''y'') (3 : ''y'') (3 : ''y'') (3 : ''y'') (3 : ''y'')) y'
f2 =: 7!:0''
f1 < _250 + f2  NB. allows pppp

f1 =: 7!:2 '3 : ''y return. {{ y + y + y + y }}'''
f2 =: 3 : 'y return. {{ y + y + y + y }}'
f3 =: 7!:2 'f2 5'
f4 =: 7!:2 '3 : ''y return. '''
f5 =: 3 : 'y return.'
f6 =: 7!:2 'f5 5'
