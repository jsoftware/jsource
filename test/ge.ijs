...
g&>/~ (-&.>   1000 ?@$~ #) ?@(# 1.5&*)&.> 1000 10000 100000,QKTEST{::1000000 10000000;10000 10000
NB. Test on hashing
g&>/~ (-&.>   1000 ?@$~ #) ?@(,&2 $ ])&.> 1000 10000 100000,QKTEST{1000000 10000
...
g&>/~ (-&.>   1000 ?@$~ #) ?@(3&, $ ])&.> 1000 10000 100000,QKTEST{1000000 10000
g&>/~ (-&.>   1000 ?@$~ #) ?@((3 , ,&2) $ ])&.> 1000 10000 100000,QKTEST{1000000 10000

32 84 117 114 105 110 103 -: (i. 256) i. a. i. ' Turing'  NB. Reversed hash must not run in place
84 85 82 73 78 71 -:  (i. 256) i. a. i. 'TURING'  NB. Not for reversed small-range either
