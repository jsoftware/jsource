1:@:(9!:19)2^_44[(echo^:ECHOFILENAME) './ge.ijs'
...
g&>/~ (-&.>   1000 ?@$~ #) ?@(# 1.5&*)&.> 1000 10000 100000,(IFRASPI+.UNAME-:'Android'){::1000000 10000000;100000 100000
NB. Test on hashing
g&>/~ (-&.>   1000 ?@$~ #) ?@(,&2 $ ])&.> 1000 10000 100000,(IFRASPI+.UNAME-:'Android'){1000000 100000
...
g&>/~ (-&.>   1000 ?@$~ #) ?@(3&, $ ])&.> 1000 10000 100000,(IFRASPI+.UNAME-:'Android'){1000000 100000
g&>/~ (-&.>   1000 ?@$~ #) ?@((3 , ,&2) $ ])&.> 1000 10000 100000,(IFRASPI+.UNAME-:'Android'){1000000 100000
