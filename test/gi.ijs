...
NB. x i.!.1 "r y --------------------------------------------------------
f =: 4 : 0"1  NB. x is (left shape;offset,range), y is (right shape;offset,range)
'ls lor'=. x [ 'rs ror' =. y
l =: /:~"1 ls ({.@] + (?@$ {:)) lor
r =: /:~"1 rs ({.@] + (?@$ {:)) ror
...
(20;0 1e6) f (10;0 1e6)
(10;0 1e6) f (20;0 1e6)
1: f/~ (<"1 ,. 0 1 10 11 12 13 14 , 200+i. 15) ,"0/ ((<"1) _5e4 1e6 , _5e5 1e7 ,: _5e6 1e8)
1: f/~ ((<"1) 5 ,. 0 1 10 11 12 13 14 , 200+i. 15) ,"0/ ((<"1) _5e4 1e6 , _5e5 1e7 ,: _5e6 1e8)
