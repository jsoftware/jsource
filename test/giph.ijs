...
13  g u: (QKTEST{1000 200) ?@# 256
''  g u: (QKTEST{1000 200) ?@# 65536
2 3 g u: (QKTEST{1000 200) ?@# 65536
13  g u: (QKTEST{1000 200) ?@# 65536

''  g 10&u: (QKTEST{1000 200) ?@# 256
2 3 g 10&u: (QKTEST{1000 200) ?@# 256
13  g 10&u: (QKTEST{1000 200) ?@# 256
''  g 10&u: RAND32 (QKTEST{1000 200) ?@# C4MAX
2 3 g 10&u: RAND32 (QKTEST{1000 200) ?@# C4MAX
13  g 10&u: RAND32 (QKTEST{1000 200) ?@# C4MAX
...
''  g x: (QKTEST{1000 10) ?@$ 3e3
2 3 g x: (QKTEST{1000 10) ?@$ 3e3

''  g %/ x: 0 1 + (QKTEST{::2 1000;2 10) ?@$ 3e3
2 3 g %/ x: 0 1 + (QKTEST{::2 1000;2 10) ?@$ 3e3
