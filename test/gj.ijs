...
NB. techo {{ |@(-/"1 % >./) (+/@:*"1)&>/"1&((1 4,:2 5)&{) (2^90x) argrand (0*y) , y ,: 0 }}"0 (20) $ 40
NB. {{ 1e_28 >  |@(-/"1 % >./) (+/@:*"1)&>/"1&((1 4,:2 5)&{) (2^90x) argrand (0*y) , y ,: 0 }}"0 (20) $ 40
{{ 1e_24 >  |@(-/"1 % >./) (+/@:*"1)&>/"1&((1 4,:2 5)&{) (2^90x) argrand (0*y) , y ,: 0 }}"0 (20) $ 40
...
techo | (1 + b * 2 + b * 3) - 1 2 3 p. b
NB. 1e_27 >!.0 | (1 + b * 2 + b * 3) - 1 2 3 p. b
...
techo | (- ^@^.)"0 ] 11 c. 1 + (%~ i:) 100
techo >./ | (- ^@^.)"0 ] 1 +&(11&c.) 1e_15 * 0.5 + 1000 ?@$ 0
NB. 1e_27 > | (- ^@^.)"0 ] 11 c. 1 + (%~ i:) 100
NB. 1e_27 > >./ | (- ^@^.)"0 ] 1 +&(11&c.) 1e_15 * 0.5 + 1000 ?@$ 0
a =: 1 +&(11&c.) 1e_20
techo (*~ - ^&2) a
techo ((* *~) - ^&3) a
NB. 1e_25 > (*~ - ^&2) a
...
techo >./ | 1 - (1&o. +&:*: 2&o.) +/ 11 c. 1. 1e_15 * _0.5 + 2 100 ?@$ 0.  NB. precision test
NB. 1e_25 > >./ | 1 - (1&o. +&:*: 2&o.) +/ 11 c. 1. 1e_15 * _0.5 + 2 100 ?@$ 0.  NB. precision test
...
assert. ((1&=@:#@[ +. (-: *. -:&(3!:0))&:(+/)) 6&c.) xx
assert. ((1&=@:#@[ +. (-: *. -:&(3!:0))&:(+/)) 7&c.) xx
assert. ((-: *. (1&>:@:# +. 0=(*/@:$))@] +. 6 -: (3!:0)@])&:(+/\) 6&c.) xx
assert. ((-: *. (1&>:@:# +. 0=(*/@:$))@] +. 7 -: (3!:0)@])&:(+/\) 7&c.) xx
assert. ((-: *. (1&>:@:# +. 0=(*/@:$))@] +. 6 -: (3!:0)@])&:(+/\.) 6&c.) xx
assert. ((-: *. (1&>:@:# +. 0=(*/@:$))@] +. 7 -: (3!:0)@])&:(+/\.) 7&c.) xx
end.
1 }} &> (<"0 i. 50) , <"1 (2 5 ?@$ 30)
...
2 -: 119 I.~ 6 c. 81 118 153 207

(_2 _71 <.&(6&c.)&,&|:&i. 2 71) -: (_2 _71 <.&,&|:&i. 2 71)  NB. Test op length
(_2 _71 <.&(7&c.)&,&|:&i. 2 71) -: (_2 _71 <.&,&|:&i. 2 71)
(_2 _71 +&(6&c.)&,&|:&i. 2 71) -: (_2 _71 +&,&|:&i. 2 71)
(_2 _71 -&(7&c.)&,&|:&i. 2 71) -: (_2 _71 -&,&|:&i. 2 71)
(_2 _71 (+ -)&(6&c.)&,&|:&i. 2 71) -: (_2 _71 (+ -)&,&|:&i. 2 71)
(_2 _71 (- -)&(7&c.)&,&|:&i. 2 71) -: (_2 _71 (- -)&,&|:&i. 2 71)
(| 6 c. xx) -: | xx =: _500 + 71 ?@$ 1000
(| 7 c. xx) -: | xx =: _500 + 71 ?@$ 1000
+/ :: 1:~ "1 (6) c. 32 32 $ 33 {. 16384  NB. oflo detection at each lane
+/ :: 1:~ "1 (6) c. 7 7 $ 8 {. 16384  NB. oflo detection at each lane
+/ :: 1:~ "1 (7) c. 32 32 $ 33 {. 1073741824  NB. oflo detection at each lane
+/ :: 1:~ "1 (7) c. 7 7 $ 8 {. 1073741824  NB. oflo detection at each lane
-/ :: 1: "2 (6) c. 0 (,:"1) 32 32 $ 33 {. _32768  NB. oflo detection at each lane
