...
fsmall`1:@.(-. ('arm64'-:9!:56'cpu') +. +./ ('avx2';'avx512') +./@:E.&> <9!:14'') (2^40x) argrand 10 10 10 10 ,: 0.05 0.3 0.6 0.9

NB. ($ #: I.@,)@:~:
'1.000000000000000000000000000000' -:`1:@.(-. ('arm64'-:9!:56'cpu') +. +./ ('avx2';'avx512') +./@:E.&> <9!:14'') 0j30 ": (*%) 11 c. 665142606648569600281099799288x
