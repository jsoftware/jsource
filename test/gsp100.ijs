1:@:(dbr bind Debug)@:(9!:19)2^_44[(prolog [ echo^:ECHOFILENAME) './gsp100.ijs'
NB. + -------------------------------------------------------------------
...
xx=: (7   3 ?@$ 2) * 7   3 5 ?@$ 100
yy=: (7 4 3 ?@$ 2) * 7 4 3 5 ?@$ 100
d f&>/c

xx=: (7   3 ?@$ 2) * 7   3 5 ?@$ 100
yy=: (7 4 3   $ 0) * 7 4 3 5 ?@$ 100
d f&>/c
