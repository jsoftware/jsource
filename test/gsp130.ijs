1:@:(dbr bind Debug)@:(9!:19)2^_44[(prolog [ echo^:ECHOFILENAME) './gsp130.ijs'
NB. % -------------------------------------------------------------------
...
xx=: (?5   3$2) * ?5   3 7$100
yy=: (?5 2 3$2) * ?5 2 3 7$100
d f&>/c

xx=: (?5   3$2) * ?5   3 7$100
yy=: ( 5 2 3$0) * ?5 2 3 7$100
d f&>/c
